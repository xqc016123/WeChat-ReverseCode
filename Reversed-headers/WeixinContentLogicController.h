...
@class NSString, OpenIMSucceedContactLogic, UIImageView, WCTopicSearchViewController, XMailBindMailControlLogic;

@interface WeixinContentLogicController : BaseMsgContentLogicController <IQQMailExt, XMailBindMailControlLogicDelegate, OpenIMSucceedContactLogicLogicDelegate, WCTopicSearchViewControllerDelegate, ContactInfoViewControllerDelegate, addContactToChatRoomDelegate, TipsViewDelegate, ITranslateMsgMgrExt>
{
    _Bool m_bTipsShow;
