...
#import "WCFinderWechatMentionCellDelegate-Protocol.h"
#import "WCFinderWechatMentionViewModelDelegate-Protocol.h"

@class NSString, UILabel, UITableView, WCFinderRefreshTableFooterView, WCFinderWechatMentionCellViewModel, WCFinderWechatMentionViewModel;

@interface WCFinderWechatMentionViewController : MMUIViewController <WCFinderWechatMentionViewModelDelegate, UITableViewDelegate, UITableViewDataSource, WCFinderRefreshTableFooterViewDelegate, WCFinderWechatMentionCellDelegate, WCFinderFeedBaseViewControllerProtocol>
{
    _Bool _isFetchMore;
    _Bool _noMoreData;
...
- (void)wechatMentionDeleteIndexPath:(id)arg1;
