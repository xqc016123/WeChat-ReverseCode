...
@interface EmoticonPackageMgr : MMUserService <MMServiceProtocol, PBMessageObserverDelegate>
{
...
- (void)callUpdatePackageListExtensionTusiji;
- (void)notifyUpdatePackageListTusiji;
