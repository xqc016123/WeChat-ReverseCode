...
@class MMTimer, MultiTalkSharingScreenBackgroundView, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, UIScrollView;
...
@interface MultiTalkContactsCollectionView : UIView <MultiTalkContactCellDelegate, UIScrollViewDelegate>
{
    ...
    MultiTalkSharingScreenBackgroundView *_bigSharingScreenBackgroundView;
...
@property(retain, nonatomic) MultiTalkSharingScreenBackgroundView *bigSharingScreenBackgroundView; // @synthesize bigSharingScreenBackgroundView=_bigSharingScreenBackgroundView;
