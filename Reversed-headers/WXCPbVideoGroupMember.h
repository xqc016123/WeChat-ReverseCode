...
@property(nonatomic) unsigned int memberRole; // @dynamic memberRole;
@property(nonatomic) unsigned int uuid; // @dynamic uuid;
@property(nonatomic) unsigned int videoScreenSharingStatus; // @dynamic videoScreenSharingStatus;
