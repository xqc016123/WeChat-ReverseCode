...
@class AddEmoticonWrap, CEmoticonWrap, EmoticonBoardView, EmoticonCustomAddLogicController, GKImagePicker, MMEmoticonView, MMToastViewController, MMUILabel, NSArray, NSNumber, NSString, UIButton, UIImage, UIImageView, UIView, WCRedEnvelopesControlData, ZCWScrollNumView;
