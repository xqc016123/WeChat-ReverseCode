...
@class CALayer, EditImageCropOverlayView, EditImageDeleteBarView, EditImageMusicLyricsWidgetTool, EditImagePOITool, EditImageScrollView, EditImageWidgetTool, MMTimer, MMUIView, NSArray, NSMutableArray, NSString, UIColor, UIImage, UIPanGestureRecognizer, UITapGestureRecognizer, UIView;
