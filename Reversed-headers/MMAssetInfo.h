...
@class MMAsset, NSNumber, NSURL, WCFinderAlbumScrollViewParamModel;
...
@interface MMAssetInfo : NSObject
{
    ...
    NSNumber *_assetSizeNum;
    struct CGRect _previewFrame;
}

- (void).cxx_destruct;
@property(retain, nonatomic) NSNumber *assetSizeNum; // @synthesize assetSizeNum=_assetSizeNum;
@property(nonatomic) _Bool bOverSize; // @synthesize bOverSize=_bOverSize;
