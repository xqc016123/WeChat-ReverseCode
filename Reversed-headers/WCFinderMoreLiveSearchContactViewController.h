...
#import "WCFinderMoreLiveSearchContactCellDelegate-Protocol.h"
...
@class MMTagTextField, MMTitleView, NSString, UIImageView, UILabel, UIMonitorTableView, UITapGestureRecognizer, WCFinderAnimationLoadingView, WCFinderMoreLiveSearchHistoryView, WCFinderRefreshTableFooterView, WCFinderSearchContactViewModel;

@interface WCFinderMoreLiveSearchContactViewController : MMUIViewController <UITextFieldDelegate, UITableViewDelegate, UITableViewDataSource, WCFinderSearchContactViewModelDelegate, WCFinderRefreshTableFooterViewDelegate, WCFinderMoreLiveSearchHistoryViewDelegate, WCFinderFeedBaseViewControllerProtocol, WCGeneralMonitorDelegate, WCFinderMoreLiveSearchContactCellDelegate>
{
