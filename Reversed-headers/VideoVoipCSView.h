...
@class AVAudioPlayer, AVCaptureVideoPreviewLayer, CContact, CMessageWrap, MMTimer, MultiTalkHDHeadView, NSString, UIImageView, UILabel, VideoVoipCSTalkingView, VoipMinimizeReportObject, WCUIAlertView, WavAudioPlayer;
