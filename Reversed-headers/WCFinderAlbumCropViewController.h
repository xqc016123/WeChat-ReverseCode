...
@interface WCFinderAlbumCropViewController : WCDragToCloseViewController <EditImageInitialViewDelegate, WCEditImageViewControllerDelegate, EditVideoLogicItemDelegate, WCEditVideoViewControllerDelegate, MMAssetPickerBrowserViewDelegate, MMAssetSelectedCollectionViewDelegate, UIScrollViewDelegate, UIGestureRecognizerDelegate, UIImagePickerControllerDelegate, MultiImageScrollViewDelegate, WCActionSheetDelegate>
{
...
+ (id)compressOriginImageForData:(id)arg1 compressRate:(double *)arg2;
+ (id)compressOriginImageForData:(id)arg1;
+ (id)compressThumbImageForData:(id)arg1 compressRate:(double *)arg2;
+ (id)compressThumbImageForData:(id)arg1;
+ (id)getVideoImageWithTime:(double)arg1 videoPath:(id)arg2 keyFrameRate:(double)arg3;
+ (id)compressThumbImageForData:(id)arg1 compressRateType:(unsigned long long)arg2 compressRate:(double *)arg3;
+ (id)compressThumbImageForData:(id)arg1 compressRateType:(unsigned long long)arg2;
...
- (void)removeSelectCheckButton;
- (void)removeAllCropButtons;
- (void)setPreviewFixedFrame;
...
- (void)fileArrayAddObject:(id)arg1 ExifInfo:(id)arg2 AVAsset:(id)arg3;
...
- (id)getEditVideoAttrWithIndex:(unsigned long long)arg1;
- (id)getCurrentEditVideoAttr;
- (id)getCurrentEditImageAttr;
- (id)getAVAssetWithIndex:(unsigned long long)arg1;
- (id)getCurrentAVAsset;
...
- (void)updateReportMode:(_Bool)arg1 originalDuration:(double)arg2 isSlowMotion:(_Bool)arg3;
...
- (void)updatePlayerAssetWithURL:(id)arg1 andUpdateHybridFile:(_Bool)arg2 AVAsset:(id)arg3;
- (void)replaceAVAssetWithURL:(id)arg1;
...
- (id)getSelectedCollectionView;
- (id)getPickerSendButton;
- (void)initBottomBar;
