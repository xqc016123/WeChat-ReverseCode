...
- (id)generateLaunchCGIUserInfo:(id)arg1 debugMode:(unsigned int)arg2 enterScene:(unsigned int)arg3 sessionId:(id)arg4 isFromBackground:(_Bool)arg5 isSilentOpen:(_Bool)arg6;
...
- (_Bool)requestABTestPermissonInfoWithAppID:(id)arg1 userName:(id)arg2 isFirstTime:(_Bool)arg3 debugModeType:(unsigned int)arg4 appIDArray:(id)arg5;
- (_Bool)requestPluginPermissonInfoWithAppID:(id)arg1 userName:(id)arg2 isFirstTime:(_Bool)arg3 isolatePluginCount:(int)arg4 debugModeType:(unsigned int)arg5 pluginIDArray:(id)arg6 scene:(unsigned int)arg7 isSilentOpen:(_Bool)arg8 syncType:(int)arg9;
