...
@interface MMConfigMgr : MMUserService <MMPackageDownloadMgrExt, MMServiceProtocol, MMKernelExt, IMMLanguageMgrExt, IMsgExt>
{
...
- (long long)getMtWaveAgcDamper;
- (long long)getMtWaveAgcDampTHR;
- (long long)getMtWaveAgcGainTHR;
- (long long)getMtWaveAgcBase;
- (long long)getMtWaveAgcDnTHR;
- (long long)getMtWaveAgcRatio;
- (long long)getMtWaveAgcTarget;
- (long long)getMtWaveAgcHeadsetGain;
- (long long)getMtWaveAgcPhnGain;
- (long long)getMtWaveAgcSpkGain;
- (long long)getMtWaveAgcMode;
