...
@class AVAudioPlayer, CEmoticonWrap, CMessageWrap, ContactUpdateHelper, EmoticonBoardView, EmoticonCustomAddLogicController, MMEmoticonView, MMTableView, MMUILabel, NSString, RichTextView, SharePreConfirmView, UIButton, UIImageView, UILabel, UIView, WCActionSheet, WCRedEnvelopesCommentInputToolView, WCRedEnvelopesStoryDargUtil, WCRedEnvelopesStoryViewController, WCUITextField;
...
- (void)onWCRedEnvelopesStoryViewControlleClickJumpAction:(id)arg1;
- (void)resetAllStatus;
