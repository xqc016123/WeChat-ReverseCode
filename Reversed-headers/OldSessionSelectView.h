...
@protocol OldSessionSelectViewDelegate;

@interface OldSessionSelectView : UIView <IFTSContactMgrExt, UITableViewDelegate, UITableViewDataSource, WCSearchDelegate, WCDataSearchDelegate, ContactsDataLogicDelegate>
{
    long long m_iSessionType;
    id <OldSessionSelectViewDelegate> m_delegate;
...
- (long long)countOfRowForRecentForwardSessions;
...
- (id)getContactInMostUseSectionAtRow:(unsigned long long)arg1;
