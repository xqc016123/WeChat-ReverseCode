...
#import "EmoticonSearchCollectionComponentDelegate-Protocol.h"
...
@property(nonatomic) _Bool searchWithRecentUse; // @synthesize searchWithRecentUse=_searchWithRecentUse;
