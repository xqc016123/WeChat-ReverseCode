...
@class FinderLiveQuestEntranceInfo, NSMutableArray, NSString;

@interface MMFinderLiveStartLiveUIStateInfo : NSObject
{
    NSString *_bulletString;
...
@property(retain, nonatomic) NSString *bulletString; // @synthesize bulletString=_bulletString;
