...
- (void)createRequest;
- (id)initWithFinderTaskId:(id)arg1 userName:(id)arg2 fromScene:(unsigned long long)arg3 extInfo:(id)arg4 successBlock:(CDUnknownBlockType)arg5 failBlock:(CDUnknownBlockType)arg6;
