...
@class MMLimitedModeSetPasswordLogic, MMLimitedModeVerifyPasswordLogic, MMUIButton, MMUILabel, MMUITextField, NSString, WCPayInputView;
@protocol MMLimitedModeIndependentVerifyViewControllerDelegate;

@interface MMLimitedModeIndependentVerifyViewController : MMUIViewController <UITextFieldDelegate, WCPayInputViewDelegate, MMLimitedModeVerifyPasswordLogicDelegate, MMLimitedModeSetPasswordLogicDelegate, MMWebViewDelegate>
{
