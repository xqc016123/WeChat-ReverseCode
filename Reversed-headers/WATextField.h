...
@class MMTimer, NSDictionary, NSString, UIColor, UIFont, WADropListView, WASafeKeyboard;
...
@property(nonatomic) __weak WASafeKeyboard *safePasswordKeyboard; // @synthesize safePasswordKeyboard=_safePasswordKeyboard;
