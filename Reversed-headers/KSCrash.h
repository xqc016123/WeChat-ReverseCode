...
- (void)reportUserException:(id)arg1 reason:(id)arg2 language:(id)arg3 lineOfCode:(id)arg4 stackTrace:(id)arg5 logAllThreads:(_Bool)arg6 terminateProgram:(_Bool)arg7 writeCpuUsage:(_Bool)arg8 dumpFilePath:(id)arg9 dumpType:(int)arg10;
