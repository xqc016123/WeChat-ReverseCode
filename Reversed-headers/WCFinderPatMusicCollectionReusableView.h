...
#import "WCFinderPatCollectionReusableView.h"
...
@interface WCFinderPatMusicCollectionReusableView : WCFinderPatCollectionReusableView <EditVideoBGMPlayerDelegate>
{
