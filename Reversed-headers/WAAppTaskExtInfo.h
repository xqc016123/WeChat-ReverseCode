...
@class NSMutableDictionary, NSString, UIViewController, WAAppTaskReferrerInfo, WAAppTaskTransitInfo, WAAppTaskWebLaunchInfo, WAPageFlowAppInfo, WAPageFlowSessionInfo, WAUINavigationController;
