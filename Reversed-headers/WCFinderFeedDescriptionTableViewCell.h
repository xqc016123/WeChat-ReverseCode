...
+ (double)descriptionTableViewCellHeightForType:(unsigned long long)arg1 timelineNoMoreCanShowHotSwitch:(_Bool)arg2;
- (void).cxx_destruct;
...
- (void)setDescriptionText:(id)arg1 actionButtonText:(id)arg2;
- (void)layoutSubviews;
