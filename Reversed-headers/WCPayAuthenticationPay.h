...
@interface WCPayAuthenticationPay : NSObject
{
    ...
    NSString *_m_1creidRenewal;
    NSString *_m_1birthDate;
    NSString *_m_1creExpireDate;
    NSString *_m_2creidRenewal;
    NSString *_m_2birthDate;
    NSString *_m_2creExpireDate;
...
@property(retain, nonatomic) NSString *m_2creExpireDate; // @synthesize m_2creExpireDate=_m_2creExpireDate;
@property(retain, nonatomic) NSString *m_2birthDate; // @synthesize m_2birthDate=_m_2birthDate;
@property(retain, nonatomic) NSString *m_2creidRenewal; // @synthesize m_2creidRenewal=_m_2creidRenewal;
@property(retain, nonatomic) NSString *m_1creExpireDate; // @synthesize m_1creExpireDate=_m_1creExpireDate;
@property(retain, nonatomic) NSString *m_1birthDate; // @synthesize m_1birthDate=_m_1birthDate;
@property(retain, nonatomic) NSString *m_1creidRenewal; // @synthesize m_1creidRenewal=_m_1creidRenewal;
