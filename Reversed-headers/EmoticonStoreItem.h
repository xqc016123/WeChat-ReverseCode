...
@class NSArray, NSData, NSString, PackActivityInfo, PersonalDesigner, SKProduct, iAPTransation;
...
@property(nonatomic) _Bool isDownloadAvaliable; // @synthesize isDownloadAvaliable=_isDownloadAvaliable;
...
@property(retain, nonatomic) PackActivityInfo *activityInfo; // @synthesize activityInfo;
