...
- (long long)rowCount;
- (id)initWithItemRows:(id)arg1 screenWidth:(double)arg2 maxCountPerLine:(long long)arg3 menuStyle:(long long)arg4 customHeaderView:(id)arg5 minWidth:(double)arg6;
