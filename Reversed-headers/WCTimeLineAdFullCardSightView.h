...
#import "WCAdInteractionCoverViewDelegate-Protocol.h"
#import "WCAdInteractionViewDelegate-Protocol.h"

@class MMTimer, MMUIImageView, NSString, UIView, WCAdInteractionCoverView, WCAdInteractionView, WCStatTimerHelper;
