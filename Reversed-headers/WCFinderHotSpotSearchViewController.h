...
#import "WCFinderSearchHotSpotViewDelegate-Protocol.h"
...
@class MMTagTextField, MMTitleView, NSMutableDictionary, NSString, UIImageView, UILabel, UIMonitorCollectionView, UIPanGestureRecognizer, UITapGestureRecognizer, WCFinderAnimationLoadingView, WCFinderSearchHistoryListView, WCFinderSearchHotSpotView, WCFinderSearchViewModel, WCFinderStreamFooterView, WCFinderStreamLayout;

@interface WCFinderHotSpotSearchViewController : MMUIViewController <UITextFieldDelegate, WCFinderSearchViewModelDelegate, WCFinderStreamLayoutDelegate, UICollectionViewDelegate, UICollectionViewDataSource, WCFinderFeedStaticCoverHighlightCollectionViewCellDelegate, WCFinderSearchContactReusableViewDelegate, WCFinderStreamFooterViewActionDelegate, WCFinderSearchHistoryListViewDelegate, WCGeneralCollectionMonitorExt, WCFinderFeedBaseViewControllerProtocol, WCGeneralMonitorDelegate, WCFinderSearchContactCollectionViewCellDelegate, WCFinderSearchHotSpotViewDelegate, UIGestureRecognizerDelegate>
{
    ...
    WCFinderSearchHotSpotView *_hotSpotView;
    ...
    unsigned long long _resultEnterTime;
}

- (void).cxx_destruct;
@property(nonatomic) unsigned long long resultEnterTime; // @synthesize resultEnterTime=_resultEnterTime;
...
@property(retain, nonatomic) WCFinderSearchHotSpotView *hotSpotView; // @synthesize hotSpotView=_hotSpotView;
...
- (void)finderSearchView:(id)arg1 didSelectedHotSpot:(id)arg2 hotWordList:(id)arg3 lastBuffer:(id)arg4;
...
- (void)reportSearchResultLeave;
- (void)showSearchResultView;
- (void)showHotSpotView;
