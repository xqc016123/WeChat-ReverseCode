...
+ (void)initialize;
+ (void)PBArrayAdd_profileBadgeUrl;
+ (void)PBArrayAdd_profileJumpUrl;
+ (void)PBArrayAdd_profileTitle;
+ (void)PBArrayAdd_profileIconUrl;
+ (void)PBArrayAdd_gameDetailJumpType;
+ (void)PBArrayAdd_gameDetailUrl;
+ (void)PBArrayAdd_indexTheme;
+ (void)PBArrayAdd_gameManagementUrl;
+ (void)PBArrayAdd_giftIconUrl;
+ (void)PBArrayAdd_installedTitle;
+ (void)PBArrayAdd_installedMore;
+ (void)PBArrayAdd_installedList;
+ (void)PBArrayAdd_msgJumpUrl;
+ (void)PBArrayAdd_msgTitle;
+ (void)PBArrayAdd_msgIconUrl;
+ (void)PBArrayAdd_productID;
+ (void)PBArrayAdd_appStoreControl;
+ (void)PBArrayAdd_feedBackEntrance;
+ (void)PBArrayAdd_libraryEntrance;
+ (void)PBArrayAdd_hot;
+ (void)PBArrayAdd_todayRecommend;
+ (void)PBArrayAdd_topRecommendBanner;
+ (void)PBArrayAdd_recentPlayInfo;
+ (void)PBArrayAdd_giftEntranceTitle;
+ (void)PBArrayAdd_giftURL;
+ (void)PBArrayAdd_classifyUrl;
+ (void)PBArrayAdd_searchPlaceholder;
+ (void)PBArrayAdd_isShowSearchEntry;
- (void).cxx_destruct;
