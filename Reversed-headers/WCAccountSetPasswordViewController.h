...
@class NSString, PasswordLogic, RichTextView, UIButton, WCAccountBindPhoneControlLogic, WCAccountTextFieldItem, WCBaseKeyboardToolBar;
@protocol WCAccountSetPasswordViewControllerDelegate;

@interface WCAccountSetPasswordViewController : WCAccountBaseViewController <ILinkEventExt, WCAccountBindPhoneControlLogicDelegate, PasswordLogicDelegate>
{
