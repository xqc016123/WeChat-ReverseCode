...
@interface WNAudioMgr : MMUserService <MMServiceProtocol, IRecordPermissionCheckExt, IFavAudioRecorderExt, IFavAudioPlayerExt, IVOIPUILogicMgrExt, ISysCallCheckExt>
{
    int _recordStatus;
