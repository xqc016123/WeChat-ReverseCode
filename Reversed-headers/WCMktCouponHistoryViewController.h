...
#import "WCMktCouponHistoryLogicControllerDelegate-Protocol.h"

@class MMTableView, NSString, UIView, WCMktCouponHistoryLogicController;

@interface WCMktCouponHistoryViewController : WCMktCardBaseViewController <UITableViewDelegate, UITableViewDataSource, WCMktCouponHistoryLogicControllerDelegate, WCActionSheetDelegate>
{
