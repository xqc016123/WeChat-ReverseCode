...
@class NSArray, NSMutableArray, NSMutableSet, NSString, QAOIMarkerManager, QAnnotationContainerView, QAppKeyCheck, QBaseVisualLayerManager, QBasicMapView, QBasicMapViewLayer, QConfigManager, QConfigPreference, QCustomLayerManager, QDataChecker, QEngineResourceManager, QHandDrawTileOverlay, QIndoorBuilding, QIndoorLevel, QIndoorManager, QIntersectionOverlayManager, QLayerManager, QLocalStateCollector, QMapContentView, QMapDataManager, QMapViewAccessibilityElement, QMediator, QOverlayContainer, QPointEventMananger, QScaleView, QStatisticer, QStyleManager, QTileOverlayManager, QTrafficManager, QUniversalMapCounter, QUserLocation, QUserLocationAccessibilityElement, QUserLocationManager, QWorldTileOverlay, QWorldTileOverlayCustomProvider, TBRegionChangeDistributor, UILongPressGestureRecognizer, UIPanGestureRecognizer, UIPinchGestureRecognizer, UIRotationGestureRecognizer, UITapGestureRecognizer;
