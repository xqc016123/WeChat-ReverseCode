...
@property(retain, nonatomic) NSString *nsNickName; // @synthesize nsNickName;
@property(retain, nonatomic) NSString *nsApproveIcon; // @synthesize nsApproveIcon;
