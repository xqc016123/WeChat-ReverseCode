...
@class CTFrameWrap, MMRichTextCoverView, NSMutableArray, NSMutableAttributedString, NSString, UIColor;
...
@interface CTRichTextView : MMCPLabel <UIGestureRecognizerDelegate, UIScrollViewDelegate, MMRichTextCoverViewDelegate>
{
    ...
    _Bool _bSelectable;
    UIColor *_highlightedRangeColor;
    double _lineSpace;
...
@property(retain, nonatomic) UIColor *highlightedRangeColor; // @synthesize highlightedRangeColor=_highlightedRangeColor;
