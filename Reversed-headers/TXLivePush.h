...
@class NSMutableArray, NSString, TXAudioEffectManager, TXCAudioVolumeEvaluator, TXCCaptureAndEnc, TXCDataReport, TXCQoS, TXCStreamUploader, TXDeviceManager, TXLivePushConfig, UITextView, UIView;
...
- (id).cxx_construct;
- (void).cxx_destruct;
@property(nonatomic) _Bool isScreenCaptureStarted; // @synthesize isScreenCaptureStarted=_isScreenCaptureStarted;
...
- (void)onSetSystemVolumeType:(long long)arg1;
- (void)onEnableCameraAutoFocus:(_Bool)arg1;
- (void)onSwitchCamera:(_Bool)arg1;
- (void)onSwitchVoiceEarMonitor:(_Bool)arg1;
