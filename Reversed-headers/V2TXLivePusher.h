...
{
    _Bool _mEnableCustomVideoCapture;
    _Bool _mIsSigned;
...
- (void).cxx_destruct;
@property _Bool mIsSigned; // @synthesize mIsSigned=_mIsSigned;
...
@property(nonatomic) _Bool mEnableCustomVideoCapture; // @synthesize mEnableCustomVideoCapture=_mEnableCustomVideoCapture;
- (id)init;
- (void)dealloc;
