...
@class AVAudioPlayer, AVCaptureVideoPreviewLayer, CContact, CMessageWrap, MMUIButton, MultiTalkHDHeadView, NSString, RingBackSoundCoordinator, RingDancingButton, UIImageView, UILabel, UIView, VideoVoipTalkingView, VoipMinimizeReportObject, WCUIAlertView;
@protocol VideoVoipViewDelegate;

@interface VideoVoipView : MMUIViewController <WCActionSheetDelegate, MMImagePickerManagerDelegate, IVOIPModeSwitchExt, IVOIPExt, AVVideoDeviceDelegate, SmallCameraViewDelegate, VideoVoipTalkingViewDelegate, IVOIPVideoDeviceDelegate, VoipUIManagerExt>
{
    int _status;
    CContact *_contact;
