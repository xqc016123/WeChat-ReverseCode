...
@class AVCaptureDeviceInput, AVCaptureSession, AVCaptureVideoDataOutput, AVCaptureVideoPreviewLayer, NSMutableArray, NSRecursiveLock, NSString, UIImage, WeVisVoipEffectMgr;
@protocol AVVideoDataSource, AVVideoDeviceDelegate, AVVideoDeviceSessionDelegate, AVVideoDeviceSetupSessionDelegate;

@interface AVVideoDevice : MMObject <AVCaptureVideoDataOutputSampleBufferDelegate, XNetEffectManagerDelegate>
{
...
+ (void)kvReportEffect:(id)arg1 roomID:(int)arg2 roomKey:(int)arg3 scene:(int)arg4;
- (void).cxx_destruct;
...
- (void)asyncUpdateVideoFilterSetting;
...
- (struct opaqueCMSampleBuffer *)processClipRotationStatus:(struct opaqueCMSampleBuffer *)arg1;
