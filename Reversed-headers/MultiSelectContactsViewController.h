...
@class ChatRoomHistoryShareStat, ContactSelectToolView, ContactSelectView, NSArray, NSDictionary, NSIndexPath, NSMutableArray, NSMutableDictionary, NSString, NewContactsSearchPanelView, TipsView, UIBarButtonItem, UIButton, UIView, WCColorProxy;
@protocol MultiSelectContactsViewControllerDelegate;

@interface MultiSelectContactsViewController : MMUIViewController <SelectTagContactsViewControllerDelegate, ContactSelectViewDelegate, SelectOpenIMContactsViewControllerDelegate, ContactPickerViewDelegate, RoomContactSelectDelegate, IChatRoomHistoryUploadExt, WCSearchDelegate, WCDataSearchDelegate, WCActionSheetDelegate, NewContactsSearchPanelViewDelegate, GroupSelectContactsViewControllerDelegate, TipsViewDelegate>
{
    ...
    _Bool _bNewHistoryMsgUploadSucc;
...
- (void).cxx_destruct;
@property(nonatomic) _Bool bNewHistoryMsgUploadSucc; // @synthesize bNewHistoryMsgUploadSucc=_bNewHistoryMsgUploadSucc;
...
- (void)onNewHistoryUploadProgressChanged:(id)arg1 total:(unsigned int)arg2 remain:(unsigned int)arg3;
- (void)onNewHistoryUploadFinish:(id)arg1 uploadInfo:(id)arg2;
- (void)onHistoryUploadProgressChanged:(id)arg1 total:(unsigned int)arg2 remain:(unsigned int)arg3;
