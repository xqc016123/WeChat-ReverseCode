...
#import "MMWebViewPlugin_NativeView.h"

#import "MMWebNativeVideoPlayerDelegate-Protocol.h"

@class MMUIButton, NSMutableDictionary, NSString;

@interface MMWebViewPlugin_NativeVideo : MMWebViewPlugin_NativeView <MMWebNativeVideoPlayerDelegate>
{
