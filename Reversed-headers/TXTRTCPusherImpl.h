...
@class NSString, UIImage, UIView, V2TRTCCloud, V2TXLivePauseParam;
...
- (void).cxx_destruct;
@property(nonatomic) _Bool mEnableLandscapePush; // @synthesize mEnableLandscapePush=_mEnableLandscapePush;
...
@property(readonly) _Bool hasEnterRoom; // @synthesize hasEnterRoom=_hasEnterRoom;
