...
#import "WCAlbumSightFullPlayViewDelegate-Protocol.h"
...
@class CContact, MMAssetPickerSendButton, MMAssetSelectCheckButton, MMScrollView, NSMutableArray, NSMutableSet, NSString, UIButton, UIView;
