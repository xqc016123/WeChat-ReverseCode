...
@interface WXGMigrationServerMgr : MMUserService <ChatMigrationCreateQRCodeDelegate, WXGMigrationServerLogicDelegate, WXGMigrationServerEntryViewControllerDelegate, WCAccountAutoLoginControlLogicExt, MMServiceProtocol>
{
...
- (void)p_showServerEntryViewController;
- (void)innerShowServerEntryViewController;
- (void)outerShowServerEntryViewController;
- (_Bool)isLogout;
- (void)doLogoutAction;
