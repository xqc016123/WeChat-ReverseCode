...
#import "WCStoryCommentUploadMgrDelegate-Protocol.h"
#import "WCStoryUploadCdnMgrDelegate-Protocol.h"
...
@interface WCStoryFacade : MMUserService <WCStoryUploadCdnMgrDelegate, WCStoryCommentUploadMgrDelegate, IClearDataMgrExt, IContactMgrExt, WCFacadeExt, IExptServiceExt, MMServiceProtocol>
{
...
- (void)changeCameraNewGuideValue;
...
- (_Bool)setFriendVisitVersionCameraRedPointRead;
