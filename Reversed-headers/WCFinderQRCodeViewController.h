...
#import "WCFinderQCCodeNameCardViewModelDelegate-Protocol.h"
#import "WCFinderQRCodeCgiDelegate-Protocol.h"

@class FinderQRCodeResponse, MMWebImageView, NSString, UIImageView, UILabel, UIView, WCFinderAuthInfoIconView, WCFinderQCCodeNameCardViewModel;

@interface WCFinderQRCodeViewController : MMUIViewController <WCFinderQRCodeCgiDelegate, WCFinderQCCodeNameCardViewModelDelegate>
{
    UIView *_cardView;
