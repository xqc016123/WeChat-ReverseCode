...
#import "WCEditSelectedCollectionViewDelegate-Protocol.h"

@class EditImageCropGridView, EditImageCropOverlayView, EditImageCropToolBarView, EditImageEmotionToolAttrView, EditImageMosaicToolAttrView, EditImagePenToolAttrView, EditImageTextToolV2, EditVideoBGMView, EditVideoMusicController, MMTimer, MMUIButton, MMUIImageView, NSMutableArray, NSMutableDictionary, NSString, RecommendedMusicInfo, UIButton, UIImage, UIImageView, UILabel, UIPanGestureRecognizer, UIView, WCEditFilterToolAttrView, WCEditImageScrollView, WCEditLoadingModeButton, WCEditSelectedCollectionView;
@protocol WCEditImageLayoutViewDelegate;

@interface WCEditImageLayoutView : MMUIView <EditImageEmotionToolAttrDelegate, EditImageCropToolBarDelegate, UIGestureRecognizerDelegate, WCEditImageOperationDelegate, EditImagePenToolAttrDelegate, EditImageMosaicToolAttrDelegate, IUiUtilExt, IMMAssetICloudExt, EditImageTextInputDelegate, WCEditFilterToolAttrViewDelegate, WCEditSelectedCollectionViewDelegate, EditVideoBgmViewDelegate>
{
...
- (id)getScreenSizeCenterImageFromOriginalImage:(id)arg1;
...
- (void)onCloseMosaicToolAttrView;
...
- (void)onEditImage:(unsigned long long)arg1 withEditEntrance:(int)arg2;
