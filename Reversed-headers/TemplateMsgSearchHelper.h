...
@interface TemplateMsgSearchHelper : MMObject <MMUIViewControllerDelegate, MsgImgFastBrowseViewControllerDelegate, RoomContactSelectDelegate, FTSMsgSearchTaskDelegate, WCSearchDelegate, WCDataSearchDelegate>
{
