...
@interface SettingMyProfileViewController : MMUIViewController <HDHeadImageViewDelegate, settingMyAccountExtInfoLogicDelegate, settingModifyAliasDelegate, IOplogExt, IMyInvoiceLogicMgrExt>
{
    ...
    long long _wccoinBalance;
}

- (void).cxx_destruct;
@property(nonatomic) long long wccoinBalance; // @synthesize wccoinBalance=_wccoinBalance;
...
- (void)showAllLikeNotify;
- (void)showTextStateLikeHistory;
- (void)showTextStateHistory;
