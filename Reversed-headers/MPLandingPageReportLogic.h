...
- (void)reportPlayRateEvent:(unsigned int)arg1 speedBefore:(double)arg2 speedAfter:(double)arg3;
...
- (_Bool)sendCGIRequest:(id)arg1 cgi:(unsigned int)arg2;
...
- (void)reportAllPerformanceEvents;
