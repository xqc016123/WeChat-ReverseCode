...
#import "MMFavThumbComponentDelegate-Protocol.h"
...
@interface MMFavCellComponent : MMComponent <IFavoritesExt, INetworkStatusMgrExt, MMFavThumbComponentDelegate>
{
...
- (void)favMusicBeignPlay:(id)arg1;
- (id)getCdnImgView;
- (id)getIconView;
