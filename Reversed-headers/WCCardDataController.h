...
@interface WCCardDataController : NSObject <UITableViewDelegate, UITableViewDataSource, tableViewDelegate, WCActionSheetDelegate, WCNewCardDetailViewControllerDelegate, ShareMessageConfirmLogicHelperDelegate, SessionSelectControllerDelegate>
{
