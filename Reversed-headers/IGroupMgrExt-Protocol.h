...
@optional
- (void)onChangeChatRoomBoxFinish:(NSString *)arg1 inChatBox:(_Bool)arg2 success:(_Bool)arg3 errorInfo:(OplogErrMsg *)arg4;
...
- (void)OnQuitGroupUIRespone:(NSString *)arg1 withResult:(_Bool)arg2 errorMsg:(NSString *)arg3;
