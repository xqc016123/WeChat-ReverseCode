...
@class CEmoticonWrap, CMessageWrap, EmoticonCustomAddLogicController, EmoticonCustomManageAddLogic, FTSWebSearchMgr, MMTableView, NSMutableArray, NSMutableDictionary, NSString, SharePreConfirmView, WCTimeLineFooterView, WSEmoticonModel, WSSImilarPageModel;
