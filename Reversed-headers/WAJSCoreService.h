...
@class JSContext, JSVirtualMachine, MMContext, NSArray, NSCondition, NSMutableArray, NSMutableDictionary, NSMutableSet, NSObject, NSString, NSThread, WAAppTaskExtInfo, WAApptaskPublicResLogic, WAContact, WAJSBindingUtilsAdaptor, WAJSCServiceInjectExtendScriptModel, WAJSContextPluginScheduler, WAJSCoreServiceOpenData, WAJSDebuggerConnection, WAJSThread, WAMagicARAdaptor, WAPackageConfig, WAProvideApiConfig, WAWebViewController, WXAudioNative, WasmAdaptor, WxaExternalInfo, wxNative;
@protocol IWXCanvasAdaptorAPI, IWXPhysxAdaptorAPI, WAJSCoreServiceDelegate, WAJSCoreServiceRemoteDelegate, WAJSServiceProtocol;

@interface WAJSCoreService : WAJSNativeBufferBase <WAJSServicePluginContextProtocol, wxNativeLogDelegate, wxNativeReportDelegate, WXFileLoaderDelegate, wxAudioNativeLogDelegate, wxAudioFileLoaderDelegate, WAMagicARAdaptorDelegate, WAJSEventHandlerContextDelegate, WAJSServiceProtocol>
{
...
- (void)checkIsMagicARAvailableWithCompletion:(CDUnknownBlockType)arg1;
- (int)getARImplType;
...
- (void)reportUserScriptInjectTime:(id)arg1 length:(long long)arg2 startTime:(unsigned long long)arg3 pluginId:(id)arg4 pluginVersion:(long long)arg5;
...
- (_Bool)UseHttpDnsAndLocalDns;
- (_Bool)DoDnsResolve:(const struct basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>> *)arg1 result:(vector_ebb6ef3e *)arg2;
