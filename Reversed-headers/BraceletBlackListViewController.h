...
@interface BraceletBlackListViewController : MMUIViewController <MultiSelectContactsViewControllerDelegate, NewChatRoomMemberItemViewDelegate, tableViewDelegate, IContactMgrExt, UITableViewDataSource, UITableViewDelegate>
{
    _Bool _deleteStatus;
