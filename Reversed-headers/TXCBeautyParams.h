...
@property(retain, nonatomic) UIImage *rightFilter; // @synthesize rightFilter=_rightFilter;
@property(nonatomic) float leftFilterStrength; // @synthesize leftFilterStrength=_leftFilterStrength;
@property(retain, nonatomic) UIImage *leftFilter; // @synthesize leftFilter=_leftFilter;
