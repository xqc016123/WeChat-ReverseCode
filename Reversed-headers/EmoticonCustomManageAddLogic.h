...
@interface EmoticonCustomManageAddLogic : MMObject <MMTipsViewControllerDelegate, StoreEmotionExchangeEmotionPackCgiDelegate, EmoticonBackupOperateMgrExt, EmoticonDescMgrExt>
{
    _Bool m_isAdding;
