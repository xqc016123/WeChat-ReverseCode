...
#import "WCPayTransferMsgCheckCgiDelegate-Protocol.h"

@class MMTipsViewController, NSDate, NSDictionary, NSMutableArray, NSMutableDictionary, NSString, TenpayCertificate, WCPayAuthenticationPay, WCPayAuthenticationPayVerifySMSStruct, WCPayAvalibleBankCardBinInfo, WCPayBindCardInfo, WCPayBindInfo, WCPayBindInfoSMS, WCPayLocalCachedData, WCPayNetworkHelper, WCPayRealNameTipsViewController, WCPayResetPasswordInfo, WCPaySingleDownloadLogic;

@interface WCPayLogicMgr : MMUserService <MMTipsViewControllerDelegate, ILinkEventExt, MMWebViewDelegate, WCPayTransferMsgCheckCgiDelegate, MMResourceMgrExt, MMImageLoaderObserver, MMKernelExt, MMServiceProtocol, WCPayNetworkHelperDelegate, MMPackageDownloadMgrExt, IMsgExt, IAutoVerifySMSExt, INewABTestMgrExt, WCPaySingleDownloadLogicDelegate>
{
