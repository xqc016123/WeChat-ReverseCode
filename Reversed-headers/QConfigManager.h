...
- (void)constructMapConfigItems:(vector_c5545690 *)arg1 callbacks:(id)arg2;
...
- (void)doDownloadFile:(const struct FileUpdateRsp *)arg1 callback:(CDUnknownBlockType)arg2;
- (void)doCheckConfigUpdate:(const vector_c5545690 *)arg1 checkCallback:(CDUnknownBlockType)arg2;
