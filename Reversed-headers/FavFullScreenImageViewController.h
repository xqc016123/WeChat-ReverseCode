...
@class EditImageForwardAndEditLogicController, MMFullScreenItemView, MMScrollView, NSMutableArray, NSString, QRCodeInMultiDisplayView, ScanQRCodeLogicController, SimpleImgInfo, UIView, WCActionSheetWithScanWXCode, WCImageTranslateLogic;
@protocol FavFullScreenImageViewControllerDelegate;

@interface FavFullScreenImageViewController : FullScreenViewController <FavForwardLogicDelegate, EditImageForwardAndEditLogicDelegate, WCImageTranslateDelegate, QRCodeInMultiDisplayViewDelegate, UIScrollViewDelegate, scrollViewDelegate, FavImageFullScreenViewContainerDelegate, WCActionSheetDelegate, BaseScanLogicDelegate>
{
