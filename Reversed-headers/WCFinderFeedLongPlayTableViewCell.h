...
@interface WCFinderFeedLongPlayTableViewCell : UITableViewCell <WCFinderPlayBarDelegate, WCFinderMegaVideoPropertyExt, WCFinderFeedContentTextClickActionDelegate, WCFinderLongPressIntervalGestureRecognizerDelegate, WCActionSheetDelegate, WCAudioSessionExt, UITextViewDelegate>
{
