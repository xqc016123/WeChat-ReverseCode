...
@interface TemplateSessionMgr : MMUserService <WXGImportMessageNotification, ISessionInfoExt, MMSessionRefreshExt, BrandTimelineMsgMgrExt, ISessionStorageDelegate, WAContactMgrExtension, IStrangerContactMgrExt, IExptServiceExt, MMServiceProtocol, IMsgExt, IContactMgrExt, IMMNewSessionMgrExt, IMMNewSessionMgrFilterExt>
{
