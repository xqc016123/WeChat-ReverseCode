...
@class MMBezelWindowController, MMWindowController, MultiDeviceManageViewController, NSMutableArray, NSString, OnlineDeviceInfoViewController;

@interface MMOnlineDeviceStatusMgr : MMUserService <IOnlineClientMgrExt, MMBezelWindowControllerDelegate, MMServiceProtocol>
{
