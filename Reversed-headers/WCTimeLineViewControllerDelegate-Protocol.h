...
@class WCDataItem, WCFinderReportPostStateModel;

@protocol WCTimeLineViewControllerDelegate <NSObject>
- (void)onWCTimeLineViewControllerLeaveForFinderPersonalCenter;
- (void)onWCTimeLineViewControllerLeaveForFinderEntranceWithPostStateModel:(WCFinderReportPostStateModel *)arg1;
