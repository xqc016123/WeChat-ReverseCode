...
@class CMessageWrap, FavoritesItem, ForwardMessageLogicController, NSDictionary, NSObject, PHObjectPlaceholder, UIButton, UIView, WCPlayerView;
...
@optional
- (NSDictionary *)generateShareInfo;
