...
@interface BTRichTextTagView : UIView
{
    ...
    NSString *_tagImageAccessibilityLabel;
    double _limitWidth;
...
@property(retain, nonatomic) NSString *tagImageAccessibilityLabel; // @synthesize tagImageAccessibilityLabel=_tagImageAccessibilityLabel;
...
- (void)setTagImageViewAccessibilityLabel:(id)arg1;
