...
{
    _Bool chatRoomDescBannerNotShow;
    ...
    NSString *chatRoomAssociateOpenIMRoomName;
}
...
- (void).cxx_destruct;
@property(nonatomic) _Bool chatRoomDescBannerNotShow; // @synthesize chatRoomDescBannerNotShow;
@property(retain, nonatomic) NSString *chatRoomAssociateOpenIMRoomName; // @synthesize chatRoomAssociateOpenIMRoomName;
