...
@class MMUIButton, NSDictionary, NSString, RichTextView, TimeoutNumber, UIButton, UIImageView, UILabel, UIView, WCActionSheet, WCPayNoticeBanner, WCPayWebImageView;
...
@property(retain) WCPayNoticeBanner *banner; // @synthesize banner=_banner;
