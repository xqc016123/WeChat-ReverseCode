...
@class GameCenterMessageRedPointInfo, GameCenterMsgDb, NSArray, NSString;
...
- (void)setMyGroupUnReadCnt:(unsigned int)arg1;
- (void)updateGameCenterMessageRedPointInfoIfChange:(_Bool)arg1;
