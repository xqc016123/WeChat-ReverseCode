...
@interface NSString (WCVMLocalizedString) <WCTValueProtocol, WCTColumnCoding>
...
+ (id)genFinderLiveNoticeQRCodeTimeStringByTimestamp:(unsigned int)arg1;
...
- (CDUnknownBlockType)sceneNote;
- (CDUnknownBlockType)exitType;
...
- (id)removeLastEmoji;
- (id)getEmojiStrs;
- (_Bool)isContainEmojiWithLooseCheck;
...
- (double)mm_fastWidthWithFont:(id)arg1;
