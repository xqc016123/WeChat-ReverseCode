...
@interface BraceletRankAddFocusViewController : MMUIViewController <SelectTagContactsViewControllerDelegate, IDeviceRankAddFocusMgrExt, IDeviceRankProfileMgrExt, UITableViewDelegate, UITableViewDataSource, WCSearchDelegate, WCDataSearchDelegate, WCActionSheetDelegate, NewContactsSearchPanelViewDelegate, TipsViewDelegate, ContactsDataLogicDelegate>
{
