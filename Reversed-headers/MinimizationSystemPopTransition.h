...
@protocol MinimizationSystemPopTransitionDelegate;
...
@interface MinimizationSystemPopTransition : NSObject <UIViewControllerAnimatedTransitioning, MMUIViewControllerTransitionInfo>
{
    ...
    id <MinimizationSystemPopTransitionDelegate> _delegate;
...
@property(nonatomic) __weak id <MinimizationSystemPopTransitionDelegate> delegate; // @synthesize delegate=_delegate;
