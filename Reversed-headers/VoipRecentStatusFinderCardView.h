...
@protocol VoipRecentStatusFinderCardContentProtocol;

@interface VoipRecentStatusFinderCardView : VoipRecentStatusCardView <RichTextLayoutDelegate, VoipRecentStatusCardViewSoundProtocol>
{
    ...
    UIView<VoipRecentStatusFinderCardContentProtocol> *_backgroundView;
...
@property(retain, nonatomic) UIView<VoipRecentStatusFinderCardContentProtocol> *backgroundView; // @synthesize backgroundView=_backgroundView;
...
- (void)layoutSubviews;
- (id)initWithFinderObject:(id)arg1 wcFinderDataItem:(id)arg2;
