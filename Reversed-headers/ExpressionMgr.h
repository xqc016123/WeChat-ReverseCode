...
@class AnimateEmojiConfig, NSArray, NSDictionary, NSMutableDictionary, NSString;

@interface ExpressionMgr : MMUserService <MMEmoticonResExt, MMServiceProtocol, IMMLanguageMgrExt>
{
