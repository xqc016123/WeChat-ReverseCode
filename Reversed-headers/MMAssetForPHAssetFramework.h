...
@class AVAsset, EditImageAttr, EditImageLogicController, NSNumber, NSURL, PHAsset;
...
- (int)requestImageDataWithMgr:(id)arg1 bConvertHeic:(_Bool)arg2 options:(id)arg3 resultHandler:(CDUnknownBlockType)arg4;
