...
@class MMMediaServiceWrapper, NSString;

@interface WAWebViewPlugin_MediaService : WAWebViewPlugin_embedView <WAOpenGlCaptureDelegate, WAAudioPlayBackDelegate>
{
    struct mutex mReaderMutex;
    struct map<unsigned int, ReaderTask, std::__1::less<unsigned int>, std::__1::allocator<std::__1::pair<const unsigned int, ReaderTask>>> mReaders;
    struct mutex mWriterMutex;
    struct map<unsigned int, WriterTask, std::__1::less<unsigned int>, std::__1::allocator<std::__1::pair<const unsigned int, WriterTask>>> mWriters;
    struct mutex mConvasidMutex;
    struct map<unsigned int, unsigned int, std::__1::less<unsigned int>, std::__1::allocator<std::__1::pair<const unsigned int, unsigned int>>> mConvasids;
