...
@class AUAudioDevice, MMTimer, NSMutableArray, NSMutableSet, NSObject, NSRecursiveLock, NSString, VoiceGroupChgMsgSeq, WXCTalkRoomData, WXTalkComponent;
@protocol IWXCVideoDataDelegate, OS_dispatch_queue;

@interface WXCTalkMgr : MMUserService <WXCCNetworkStatusExt, AUAudioDataSource, AVAudioPlayerDelegate, IAUAudioDeviceExt, MMKernelExt, MMServiceProtocol, WXCNetWorkDelegate>
{
...
- (_Bool)sendWXTalkVideoModeRequest:(id)arg1 roomId:(unsigned int)arg2 roomKey:(unsigned long long)arg3 Action:(int)arg4 fileMd5:(id)arg5 fileId:(id)arg6;
- (void)handleSubscribeScreenSharingResponse:(id)arg1 retCode:(int)arg2 backfillData:(id)arg3;
- (_Bool)sendWXTalkSubscribeScreenSharingRequest:(id)arg1 roomId:(unsigned int)arg2 roomKey:(unsigned long long)arg3 SubscribeMemberList:(id)arg4;
...
- (void)subscribeVideoForUser:(id)arg1 isSharedScreenData:(_Bool)arg2 isCancel:(_Bool)arg3;
