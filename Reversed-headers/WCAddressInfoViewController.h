...
@class MMPickLocationViewController, NSIndexPath, NSMutableArray, NSString, POIItem, UIButton, UILabel, UITextView, WCAddressMultiPickerItem, WCBaseKeyboardToolBar, WCBaseTextFieldItem, WCBaseTextViewItem;
@protocol WCAddressInfoViewControllerDelegate;

@interface WCAddressInfoViewController : WCAddressBaseViewController <CNContactPickerDelegate, MMPickLocationViewControllerDelegate, WCAddressHalfScreenDelegate, ILocationMgrExt>
{
