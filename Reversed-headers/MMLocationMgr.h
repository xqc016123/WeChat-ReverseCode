...
@interface MMLocationMgr : MMUserService <PBMessageObserverDelegate, CLLocationManagerDelegate, MMServiceProtocol>
{
    ...
    MMLocationDB *m_fourthLocationDB;
...
- (unsigned long long)updateFourthAddressByLocation:(struct CLLocationCoordinate2D)arg1;
- (unsigned long long)updateAddressByLocation:(struct CLLocationCoordinate2D)arg1;
- (id)getFourthAddressByLocation:(struct CLLocationCoordinate2D)arg1;
