...
@interface UIButton (Truncation)
+ (CDUnknownBlockType)zz_create;
- (id)truncatedRangeReplaceWithThreeDotsWithMaxSize:(struct CGSize)arg1;
- (id)truncatedTextWithMaxSize:(struct CGSize)arg1;
...
- (void)layoutVerticalMarginTop:(double)arg1 spacing:(double)arg2;
