...
@interface MinimizeTaskExtInfo : MMObject <PBCoding>
{
    ...
    unsigned long long generateType;
    unsigned long long bizScene;
    NSString *bizId;
    NSString *bizSubId;
    NSString *bizName;
...
@property(nonatomic) unsigned long long bizScene; // @synthesize bizScene;
@property(nonatomic) unsigned int generateScene; // @synthesize generateScene;
@property(nonatomic) unsigned long long generateType; // @synthesize generateType;
