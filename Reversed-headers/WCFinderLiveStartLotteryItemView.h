...
@class MMUILabel, MMUITextField, NSString, UIImageView, UISwitch, UIView;
@protocol WCFinderLiveStartLotteryItemViewDelegate;

@interface WCFinderLiveStartLotteryItemView : MMUIView <UITextFieldDelegate, WCActionSheetDelegate>
{
...
- (void)updateItemText:(id)arg1 suffixText:(id)arg2 placeHolder:(id)arg3 switchOn:(_Bool)arg4;
