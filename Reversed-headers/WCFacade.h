...
@class MemoryMappedKV, MyWCDB, NSMutableArray, NSMutableDictionary, NSMutableSet, NSRecursiveLock, NSString, WCAdvertiseCommentUploadMgr, WCAdvertiseDataHelper, WCAdvertiseLogicMgr, WCBGImgLogic, WCBGRecommendMgr, WCBrowseInfo, WCCanvasCommonFileLoader, WCCanvasTypeMgr, WCCommentUploadMgr, WCDataItem, WCDownloadImageCdnMgr, WCDownloadMgr, WCDownloadVideoCDNMgr, WCFacadeDynamicConfig, WCGroupMgr, WCInputTextCacheMgr, WCLogicMgr, WCMomentsContentDiscoverer, WCNotificationCenterMgr, WCOperationSetting, WCPatternCacheMgr, WCPreloadLogicMgr, WCRealFeedExposureItem, WCSnsABTestMgr, WCSnsLocalCacheMgr, WCStrangerCommentMgr, WCTimelineMgr, WCUploadMgr;

@interface WCFacade : MMUserService <IContactMgrExt, MMConfigMgrExt, INewABTestMgrExt, PBMessageObserverDelegate, IExptServiceExt, WCTimelineDelegate, MMCleanCacheMgrExt, MMServiceProtocol, WCBGImgLogicNotity, WCDownloadMgrDelegate, WCCommentUploadMgrDelegate, WCUploadMgrDelegate, WCNotificationCenterMgrDelegate, WCHomepageDelegate, WCLogicMgrDelegate, WCFacadeExt, WCBGRecommendMgrDelegate, WCGroupMgrExt, WCAdvertiseCommentUploadMgrDelegate, IMMFontMgrExt, WCPreloadLogicDelegate, IMsgExt, WCCdnDownloadImageDelegate>
{
    MyWCDB *m_database;
...
- (_Bool)stopPreloadSNSVideoWithMediaItem:(id)arg1 downloadTaskInfo:(id *)arg2;
...
- (void)onHomepage:(id)arg1 yearMonthInfosUpdated:(id)arg2;
- (void)onHomepage:(id)arg1 limitFeedIdChanged:(unsigned long long)arg2;
- (void)onHomepageClearJumpState:(id)arg1;
- (void)onHomepage:(id)arg1 prePageUpdate:(id)arg2;
- (void)onHomepage:(id)arg1 fetchDataBeforeJumpWithNewItems:(id)arg2 success:(_Bool)arg3;
- (void)onHomepageUpdate:(long long)arg1 tip:(id)arg2 username:(id)arg3 withAdded:(id)arg4 andChanged:(id)arg5 andDeleted:(id)arg6;
...
- (void)setContentDescHeight:(double)arg1 forWidth:(double)arg2 withDataItem:(id)arg3 isShowDetail:(_Bool)arg4;
- (void)setContentDescHeight:(double)arg1 forWidth:(double)arg2 withDataItem:(id)arg3;
- (double)contentDescHeightForWidth:(double)arg1 withDataItem:(id)arg2 isShowDetail:(_Bool)arg3;
