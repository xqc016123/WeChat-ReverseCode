...
@interface VOIPMgr : MMUserService <AVVideoDataSource, AUAudioDataSource, IAUAudioDeviceExt, ISysCallCheckExt, AVVideoDeviceDelegate, IVOIPSyncExt, PBMessageObserverDelegate, INetworkStatusMgrExt, CNetworkStatusExt, CMobileSIMTypeExt, MMServiceProtocol, AVVideoDeviceSessionDelegate>
{
    ...
    unsigned long long audioDeviceModeBeforeStopTalk;
    ...
    struct __CVBuffer *localImageBuffer;
    struct __CVBuffer *remoteImageBuffer;
...
@property(readonly, nonatomic) unsigned long long audioDeviceModeBeforeStopTalk; // @synthesize audioDeviceModeBeforeStopTalk;
@property(readonly, nonatomic) _Bool mIsRecordStarted; // @synthesize mIsRecordStarted;
@property(readonly, nonatomic) _Bool mIsAudioStarted; // @synthesize mIsAudioStarted;
...
- (int)doSimuCallJudge:(id)arg1 isCallin:(_Bool)arg2 inviteType:(int)arg3 roomId:(int)arg4 roomKey:(long long)arg5 timeStamp:(long long)arg6;
...
- (void)remoteVideoRendering:(struct ScalePlane *)arg1 decData:(struct __CVBuffer *)arg2 useHardDecData:(_Bool)arg3;
- (void)localVideoRendering:(char **)arg1 width:(int)arg2 height:(int)arg3;
- (void)localVideoRendering:(struct __CVBuffer *)arg1;
- (struct CGSize)updateRendering:(struct CGSize)arg1 OrginalSize:(struct CGSize)arg2 State:(_Bool)arg3 IsLocalVideo:(_Bool)arg4;
...
- (int)GetNicInfo:(vector_f77d159f *)arg1 andFrom:(struct basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>)arg2;
- (struct basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>)GetCellularIspInfoStr;
...
- (void)SendNewStatReport:(unsigned long long)arg1 memberId:(unsigned int)arg2 dialReport:(id)arg3 channelReport:(id)arg4 engineReport:(id)arg5 engineExtReport:(id)arg6 directConnReport:(vector_ebb6ef3e)arg7 relayConnReport:(vector_ebb6ef3e)arg8 engineMPReport:(vector_ebb6ef3e)arg9 natReport:(list_83d31cf8)arg10;
