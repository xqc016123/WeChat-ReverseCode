...
@class CContact, MMTableView, MMUIButton, MMUILabel, NSArray, NSMutableArray, NSMutableDictionary, NSString, UIImageView, UITextField, WCPayGPMemberFillMoneyCell;
...
- (void)setupData;
- (void)layoutSubviews;
- (void)refreshContentViewWithChatroomContact:(id)arg1 selectedContactArray:(id)arg2 userPayAmountDict:(id)arg3 launchScene:(unsigned long long)arg4 pfContactList:(id)arg5;
