...
@class CAGradientLayer, MMUILabel, NSMutableArray, NSString, UIButton, UIGestureRecognizer, UIImageView, UIView, WSPlayerMaskView, WSPlayerSimpleProgressBar, WSVideoModel, WSVideoOperateButton, WSVideoSourceView;
@protocol WSVideoPagingPlayerViewDelegate;

@interface WSVideoPagingPlayerView : WSVideoPlayerView <IWSVideoThumbExt, WSPlayerMaskViewDelegate, UIGestureRecognizerDelegate>
{
    ...
    MMUILabel *_seeMoreLabelInShareScene;
    WSVideoOperateButton *_wowBrandLabelInShareScene;
    MMUILabel *_titleLabelInShareScene;
    struct CGRect _titleFrame;
}

- (void).cxx_destruct;
@property(nonatomic) _Bool isRecommendStyle; // @synthesize isRecommendStyle=_isRecommendStyle;
@property(retain, nonatomic) MMUILabel *titleLabelInShareScene; // @synthesize titleLabelInShareScene=_titleLabelInShareScene;
@property(retain, nonatomic) WSVideoOperateButton *wowBrandLabelInShareScene; // @synthesize wowBrandLabelInShareScene=_wowBrandLabelInShareScene;
@property(retain, nonatomic) MMUILabel *seeMoreLabelInShareScene; // @synthesize seeMoreLabelInShareScene=_seeMoreLabelInShareScene;
...
- (void)resumeNormalStyle;
- (void)displayAsRecommendStyle;
- (void)stop;
- (void)pause;
- (void)replayVideo;
- (void)play;
