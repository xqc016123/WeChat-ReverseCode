...
@interface WASplashADViewController : MMUIViewController <WAWebViewMutiFuncMenuViewDelegate, WAWebViewMutiFuncMenuViewDataSource, WACapsuleViewDelegate, WAWebViewControllerMenuActionCustomDelegate, WACapsuleMenuDataSource>
{
    _Bool _didAppear;
