...
@interface WSVideoFlowPagingViewController : WSVideoFlowBaseViewController <UITableViewDelegate, UITableViewDataSource, tableViewDelegate, WSVideoFlowDataDelegate, MMRefreshTableFooterDelegate, WSVideoPagingPlayerViewDelegate, ICdnComMgrExt, WSVideoWowEducateDelegate>
{
    UIView *_navBarBkg;
