...
#import "BypSendEmotionMessageMgrDelegate-Protocol.h"
#import "BypSendMessageMgrDelegate-Protocol.h"
...
- (void)stopChatRoomDownlaodAllResource:(id)arg1;
...
- (_Bool)RevokeMsg:(id)arg1 MsgWrap:(id)arg2 Counter:(unsigned int)arg3 revokeTicket:(id)arg4;
