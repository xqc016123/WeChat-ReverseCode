...
@protocol MMWebNativeVideoPlayerDelegate <NSObject>
...
- (void)onPlayerProcessStateChanged:(unsigned long long)arg1 viewId:(unsigned int)arg2 params:(NSDictionary *)arg3;
