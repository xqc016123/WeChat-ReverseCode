...
@interface WCFinderLiveModifyMusicCGI : WCFinderLiveBaseCgi
{
...
- (void)createRequest;
- (id)initWithFinderTaskId:(id)arg1 songIdList:(id)arg2 liveCookies:(id)arg3 successBlock:(CDUnknownBlockType)arg4 failBlock:(CDUnknownBlockType)arg5;
