...
@class MMActionSheetQRCodeRowView, MMImageScrollViewHelper, MMLoadingView, MMProgressViewEx, MMUIButton, NSArray, NSString, OCRTransHalfScreenViewController, QRCodeInMultiDisplayView, ScanQRCodeLogicController, SessionForwardRecordLogic, SharePreConfirmView, UIImage, UIImageView, UIView, WCImageTranslateLogic, WCMediaItem, WCMediaItemWrap, WCMomentsScrollActionSheet, WXFullScreenGestureRecognizer;
@protocol WCImageFullScreenViewContainerDelegate;

@interface WCImageFullScreenViewContainer : MMUIScrollView <MMScrollActionSheetDelegate, BaseScanLogicDelegate, FullScreenGestureDelegate, WCImageTranslateDelegate, OCRTransHalfScreenViewControllerDelegate, QRCodeInMultiDisplayViewDelegate, SharePreConfirmViewDelegate, RecentForwardScrollViewDelegate, MMActionSheetQRCodeRowViewDelegate, UIScrollViewDelegate, MMImageScrollViewHelperDelegate, WCFacadeExt>
{
