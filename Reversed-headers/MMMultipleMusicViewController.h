...
@class CShakeChecker, MMMusicInfo, MMMusicLocalFileDataInfo, MMMusicPageView, MMMusicPlayerModeTipView, MMMusicSliderControlView, MMScrollActionSheet, MMScrollView, MMTimer, MMTipsViewController, MMWebImageView, MPVolumeView, NSMutableArray, NSString, SendAppMsgHandler, UIButton, UIImageView, UILabel, WCActionSheet;

@interface MMMultipleMusicViewController : MMUIViewController <WCActionSheetDelegate, SendAppMsgHandleDelegate, UIScrollViewDelegate, MMScrollActionSheetDelegate, MMMusicPageViewDelegate, ShakeCheckerDelegate, IMusicPlayerExt, MMTipsViewControllerDelegate, FileDetailLogicDelegate>
{
