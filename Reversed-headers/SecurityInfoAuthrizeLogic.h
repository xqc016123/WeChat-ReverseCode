...
@class MMUIViewController, NSMutableArray, NSMutableDictionary, NSString, UINavigationController, UIScreenEdgePanGestureRecognizer, UserIdAuthorizePageInfo, WAAuthorizeInfoPageSheet, WAAuthorizeUserIdPageSheet, WAMenuPopInteractiveTransition, WXAPhoneInfo;
