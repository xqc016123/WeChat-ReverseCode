...
#import "WCHKWorkoutLogicDelegate-Protocol.h"

@class BlueManager, NSMutableArray, NSMutableDictionary, NSString, WCDeviceAuthLogic, WCDeviceM7Logic, WCDeviceNetworkLogicMgr, WCDeviceSendDataToManufacturSvrLogic, WCDeviceWifiStateLogic, WCHKWorkoutLogic;

@interface WCDeviceBrandMgr : MMUserService <WCHKWorkoutLogicDelegate, MMServiceProtocol, WCDeviceAuthLogicDelegate, WCDeviceNetworkLogicMgrDelegate, WCDeviceSendDataToManufacturSvrLogicDelegate, WCDeviceWifiStateLogicDelegate, WCDeviceM7LogicDelegate, IMsgExt, BlueAdapterDelegate, IWCDeviceAccountMgrExt, IContactMgrExt, IPreEnterWechatLogicExt>
{
...
- (_Bool)canUploadStepCount:(int)arg1;
