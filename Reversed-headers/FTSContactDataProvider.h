...
@interface FTSContactDataProvider : MMUserService <IContactMgrExt, IFriendListMgrExt, IContactLabelMgrExt, IMMNewSessionMgrExt, WXGImportMessageNotification, MMServiceProtocol>
{
    ...
    NSMutableDictionary *_dicPinYinCache;
}

- (void).cxx_destruct;
- (void)clearPinYinCache;
- (void)updateDicPinYin:(id)arg1;
- (void)setDicPinYinCache:(id)arg1;
- (id)getDicPinYinCache;
...
- (_Bool)shouldSearchSingleContact:(id)arg1 username:(id)arg2;
