...
@class CContact, MMTimer, MTScreenSharingTipsView, MultiTalkHDHeadView, MuteIconView, NSMutableArray, NSString, UIImageView, UILabel, WCVideoRender;
...
@interface MultiTalkContactCell : UIView <MultiTalkContactCellExt, MultiTalkContactCellWaittingTimerExt>
{
    ...
    MTScreenSharingTipsView *m_screenSharingTipsView;
...
@property(retain, nonatomic) MTScreenSharingTipsView *m_screenSharingTipsView; // @synthesize m_screenSharingTipsView;
