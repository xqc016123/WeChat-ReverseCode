...
@interface MMHeavyUserMonitorMgr : MMUserService <MMHeavyUserDataSourceDelegate, MMHeavyUserClassifierDelegate, MMHeavyUserEvaluatorDelegate, MMStackReportConnectionDelegate, MMDiskUsageScannerDelegate, MMServiceProtocol>
{
