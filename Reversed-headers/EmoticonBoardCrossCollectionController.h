...
@interface EmoticonBoardCrossCollectionController : MMObject <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, EmoticonDescMgrExt, ExpressionMgrExt, EmoticonStoreItemExt, EmoticonBoardCrossCollectionEmojiPageDelegate, EmoticonBoardCrossCollectionEmoticonPageDelegate, EmoticonBoardCrossCollectionCameraEmoticonEntryPageDelegate, EmoticonBoardCrossCollectionRecommendPageDelegate>
{
    _Bool _darkMode;
