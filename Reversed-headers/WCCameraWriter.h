...
@class AVAssetWriterInput, AVAssetWriterInputPixelBufferAdaptor, GPUImageFramebuffer, NSObject, NSString, NSURL;
@protocol OS_dispatch_queue, WCCameraWriterDelegate;

@interface WCCameraWriter : GPUImageMovieWriter <GPUImageMovieWriterDelegate, AQAudioRecorderDelegate>
{
