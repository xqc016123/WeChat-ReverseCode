...
@class CEmoticonWrap, CMessageWrap, EmoticonCustomAddLogicController, EmoticonStoreItem, EmoticonStoreLensDesignerView, EmotionLink, EmotionStoreDetailDesignerContainerView, MMImageBrowseView, MMStoreEmotionAllCell, MMUIActivityIndicatorView, MMUIButton, NSMutableArray, NSString, RichTextView, UIButton, UIImageView, UILabel, UIView, WCActionSheet;

@interface MMEmotionMsgBrowseViewController : MMUIViewController <EmoticonStoreCellDelegate, UIGestureRecognizerDelegate, IStoreEmotionDesignerInfoMgrExt, EmoticonDescMgrExt, MMImgageBrowseViewDelegate, EmoticonCustomAddLogicControllerDelegate, WebSearchMgrDelegate, EmoticonLensMgrExt, ILinkEventExt, EmoticonStoreLensDesignerViewDelegate, WCActionSheetDelegate, EmoticonStoreItemExt, IEmoticonDownloadExt, IMsgRevokeExt>
{
