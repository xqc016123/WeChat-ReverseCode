...
@class MMSearchPanGestureController, MMTableView, MMUISearchBar, MMUIViewController, NSString, UIGestureRecognizer, UIView, WCSearchController, WCTimeLineFooterView;
