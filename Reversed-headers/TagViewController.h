...
+ (id)genImage:(unsigned long long)arg1 forButton:(id)arg2 isHighLight:(_Bool)arg3 isDarkMode:(_Bool)arg4;
+ (id)genImage:(unsigned long long)arg1 forButton:(id)arg2 isHighLight:(_Bool)arg3;
- (void).cxx_destruct;
