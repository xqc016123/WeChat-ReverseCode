...
@class MMMusicDotMVDataSource, MMMusicLiveLyricDisplayView, MMMusicLyricService, MMMusicMVModel, MMMusicMVPlayerBgView, MMMusicPlayerMgr, MMTimer, MVImageLoader, MVPlayerConfiguration, MVPreloadManager, NSMutableArray, NSString;
@protocol MMMVPlayerDelegate;

@interface MMMVPlayer : NSObject <MMMusicMVPlayerBgViewDelegate, MMMusicMVPLayerBgviewDataSource, MMMusicDotMVDataSourceDelegate, IMMMusicLyricServiceExt>
{
    _Bool _muted;
