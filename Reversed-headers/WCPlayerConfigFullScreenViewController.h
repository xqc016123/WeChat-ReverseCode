...
@class ForwardMessageLogicController, NSObject, NSString, UIImage, UIView, WCPlayerFullScreenConfigControlView, WCPlayerPlayArgs, WCPlayerView, WXFullScreenGestureRecognizer;
@protocol WCPlayerConfigViewControllerDelegate, WCPlayerMediaExt;

@interface WCPlayerConfigFullScreenViewController : FullScreenViewController <WCPlayerConfigDelegate, FullScreenGestureDelegate, ForwardMessageLogicDelegate, WCPlayerDownloaderExt, WCFacadeExt, MonoServiceMgrExt, SNSVideoABTestExt>
{
...
- (id)generateConfig;
- (void)applyShareButtonSafeAreaRule;
