...
- (void)createRequest;
- (id)initWithPosterUsername:(id)arg1 finderUsername:(id)arg2 refObjectID:(id)arg3 reportScene:(unsigned long long)arg4 optype:(unsigned long long)arg5 enterType:(unsigned int)arg6 sessionBuffer:(id)arg7 successBlock:(CDUnknownBlockType)arg8 failureBlock:(CDUnknownBlockType)arg9;
