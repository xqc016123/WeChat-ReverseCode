...
@interface WCFinderLiveRosterSelectViewController : MMUIViewController <UITableViewDelegate, UITableViewDataSource>
{
...
- (id)initWithVisibilityFileLists:(id)arg1 andChoosenIdLists:(id)arg2;
