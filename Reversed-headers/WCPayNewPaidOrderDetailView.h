...
#import "WCPayCheckMchPosCgiDelegate-Protocol.h"
#import "WCPayImageMaskViewFilledDelegate-Protocol.h"
#import "WCPayLotteryViewDelegate-Protocol.h"
#import "WCPayMchFavViewDelegate-Protocol.h"
#import "WCPayPaidDetailFinderInfoViewDelegate-Protocol.h"
#import "WCPayPaidOrderShowInfoViewDelegate-Protocol.h"
#import "WCPayUnCheckMchPosCgiDelegate-Protocol.h"

@class CShakeChecker, MMUILabel, NSMutableArray, NSString, UIBezierPath, UIButton, UIImageView, UILabel, UIScrollView, UIView, WCPayCheckMchPosCgi, WCPayControlData, WCPayImageMaskView, WCPayLotteryView, WCPayMchFavView, WCPayPaidDetailFinderInfoView, WCPayUnCheckMchPosCgi, WCPayWebImageView;
@protocol WCPayNewPaidOrderDetailViewDelegate;

@interface WCPayNewPaidOrderDetailView : MMUIView <WCPayPaidOrderShowInfoViewDelegate, WCPayImageMaskViewFilledDelegate, ShakeCheckerDelegate, WCPayLotteryViewDelegate, WCPayMchFavViewDelegate, WCPayCheckMchPosCgiDelegate, WCPayUnCheckMchPosCgiDelegate, WCPayPaidDetailFinderInfoViewDelegate>
{
    _Bool _isShaking;
    _Bool _bCanShake;
