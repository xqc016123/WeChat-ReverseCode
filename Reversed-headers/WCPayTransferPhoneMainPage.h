...
#import "WCPayTransferDelayOptionViewDelegate-Protocol.h"

@class MMTipsViewController, NSString, RichTextView, TransferPhoneGetRcvrResp, UIButton, UIImageView, UILabel, UIView, WCPayCss, WCPayDecimalKeyboardView, WCPayNavigationView, WCPayTextField, WCPayTransferDelayOptionView, WCPayWebImageView, WCUIAlertView;
...
@property(retain) UIButton *checkNameButton; // @synthesize checkNameButton=_checkNameButton;
