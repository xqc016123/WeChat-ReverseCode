...
@interface StoreEmotionRecoverMgr : MMUserService <StoreEmotionRecoverLogicObjectDelegate, StoreEmotionDownloadLogicObjectDelegate, IMsgExt, StoreEmotionAddTaskDelegate, StoreEmotionDeleteTaskDelegate, StoreEmotionDeleteExt, CNetworkStatusExt, StoreEmotionFetchFollowedDesignersUpdateLogicDelegate, MMServiceProtocol>
{
    int _scene;
