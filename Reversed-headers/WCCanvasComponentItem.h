...
@class NSMutableArray, NSString, WCAdSphereCardInfo, WCCanvasAbilitySliderInfo, WCCanvasComponentBottomSwipeInfo, WCCanvasComponentButtonInfo, WCCanvasComponentFloatActionButtonInfo, WCCanvasComponentFloatConversionBarInfo, WCCanvasComponentFloatJumpInfo, WCCanvasComponentFullScreenImageInfo, WCCanvasComponentGeneralVideoInfo, WCCanvasComponentLocationInfo, WCCanvasComponentNewScrollInfo, WCCanvasComponentOverLongImageInfo, WCCanvasComponentPreloadWebViewInfo, WCCanvasComponentPureImageInfo, WCCanvasComponentShareInfo, WCCanvasComponentSightVideoInfo, WCCanvasComponentSocialInfo, WCCanvasComponentStreamVideoInfo, WCCanvasComponentTelephoneInfo, WCCanvasComponentTextAreaInfo, WCCanvasComponentTurnImagesInfo, WCCanvasComponentUltraWebViewInfo, WCCanvasComponentWebStoreInfo, WCCanvasFloatLayoutInfo, WCCanvasFrameLayoutInfo, WCCanvasLinearLayoutInfo, WCCanvasRadarChartInfo, WCCanvasRandomLayoutInfo, WCCanvsComponentPanoramaInfo, WCCanvsComponentScrollGroupListInfo;
...
- (_Bool)updateSocialCardDynamicInfoWith:(id)arg1;
