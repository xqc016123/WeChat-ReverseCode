...
@class MMPickLocationViewController, NSString, UITableView, WCUIAlertView;

@interface WCFinderDebugViewController : MMUIViewController <UITableViewDelegate, UITableViewDataSource, MMRegionPickerViewControllerDelegate, MMPickLocationViewControllerDelegate, WCFinderPostViewControllerDelegate>
{
