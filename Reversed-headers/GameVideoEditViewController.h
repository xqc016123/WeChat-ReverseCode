...
#import "EditVideoOptionsDelegate-Protocol.h"
...
@interface GameVideoEditViewController : MMUIViewController <EditVideoLogicItemDelegate, WAAppActionSheetDelegate, EditVideoOptionsDelegate>
{
