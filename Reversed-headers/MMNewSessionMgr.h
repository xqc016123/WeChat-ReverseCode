...
#import "WCDBSpecifiedRecoverViewControllerDelegate-Protocol.h"
...
- (void)onSpecifiedRouterInfos:(id)arg1 recovered:(_Bool)arg2;
...
- (id)recentForwardSessions:(unsigned long long)arg1 maxCount:(long long)arg2 timeRange:(unsigned int)arg3;
...
- (void)DeleteSessionOfUser:(id)arg1 forceDelete:(_Bool)arg2;
