...
#import "WCFinderAddPOIViewModelDelegate-Protocol.h"
...
- (void)onBindUnbindablePOI;
- (void)onBindPOIFailure;
...
- (void)showPickLocationVCInViewController:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)showTipsBubble;
- (void)tapBackButton;
