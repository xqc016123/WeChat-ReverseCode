...
- (void)reportFavSearchTime:(unsigned long long)arg1 QueryTime:(unsigned long long)arg2 CheckDBTime:(unsigned long long)arg3 ResultCount:(unsigned int)arg4 isFromFav:(_Bool)arg5 byType:(int)arg6 tagsCount:(int)arg7 isFTS5:(_Bool)arg8;
...
- (void)tryLogResultNoActionForSubSearch:(id)arg1 hasResult:(_Bool)arg2 displayInfo:(id)arg3 searchType:(unsigned long long)arg4;
- (void)logHitResultForSubSearch:(id)arg1 searchType:(unsigned long long)arg2 displayInfo:(id)arg3;
...
- (void)logInviteAddressFriend:(unsigned long long)arg1;
