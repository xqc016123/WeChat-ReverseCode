...
#import "WCRedEnvelopesLiveStreamReceiveControlLogicDelegate-Protocol.h"
...
- (void)OnWCRedEnvelopesLiveStreamReceiveControlLogicReceiveDone:(int)arg1 messageWrap:(id)arg2;
