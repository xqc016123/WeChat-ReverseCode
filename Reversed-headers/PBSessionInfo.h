...
@property(nonatomic) _Bool bSpecialAttention; // @synthesize bSpecialAttention;
@property(nonatomic) unsigned int exclusiveHbCount; // @synthesize exclusiveHbCount;
