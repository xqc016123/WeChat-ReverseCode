...
@class BaseRequest, FinderBaseRequest, FinderCategoryInfo, FinderClientStatus, FinderGetRelatedEntranceInfo, FinderGetRelatedListReq_GetColumnFeedInfo, FinderGetRelatedListReq_GetRelatedColumnTopicInfo, FinderGetRelatedListReq_SwitchColumnInfo, FinderLiveClientStatus, FinderSectionInfo, NSData, NSMutableArray, NSString;
