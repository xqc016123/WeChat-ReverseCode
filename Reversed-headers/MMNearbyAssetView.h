...
@class MMAssetSelectCheckButton, MMNearbyAssetInfo, NSString, UIImageView, UILabel, UIView;
@protocol MMImagePickerControlCenter, MMNearbyAssetViewDataSource, MMNearbyAssetViewDelegate;
