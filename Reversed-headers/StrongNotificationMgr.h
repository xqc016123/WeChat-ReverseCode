...
@interface StrongNotificationMgr : MMUserService <IMMNewSessionMgrExt, MMKernelExt, StrongNotificationExclusiveMsgLogicDelegate, IRecordControllerExt, IOplogExt, IContactMgrExt, MMSightCameraExtention, WCFinderAppPushExt, MMServiceProtocol, IMsgExt, PBMessageObserverDelegate>
{
...
- (void)reportStrongNotificationReceiveLogWithForcePushId:(id)arg1 fromUserName:(id)arg2;
