...
- (void)addBizFileStat:(id)arg1 bizType:(long long)arg2 fileSize:(unsigned long long)arg3;
- (_Bool)deleteFile:(id)arg1 matchInfo:(struct MMBizMatchInfo)arg2 inFolder:(id)arg3 withScanConfig:(id)arg4 fileSize:(unsigned long long *)arg5 withScanStat:(id)arg6;
