...
@interface FindContactSearchViewCellInfo : WCTableViewNormalCellManager <SearchContactDataProviderDelegate, IOpenImResourceMgrExt, MMWebViewDelegate, WCSearchDelegate, WCDataSearchDelegate, IBrandServiceSearchExt, PBMessageObserverDelegate, contactInfoDelegate>
{
