...
@class AMRAudioPlayer, CDownloadVoiceMgr, NSString, SPXAudioPlayer, SilkAudioPlayer;

@interface AudioReceiver : MMUserService <AMRAudioPlayerDelegate, SPXAudioPlayerDelegate, SilkAudioPlayerDelegate, DownloadVoiceDelegate, INewSyncExt, MMServiceProtocol>
{
...
- (void)notifyOnEndPlaying:(unsigned int)arg1 isForceStop:(_Bool)arg2;
- (void)notifyOnPlaying:(unsigned int)arg1 ErrNo:(int)arg2;
