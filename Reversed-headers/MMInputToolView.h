...
#import "TranslateLanguageSelectViewDelegate-Protocol.h"
#import "TranslateToolViewDelegate-Protocol.h"
#import "UITextViewDelegate-Protocol.h"
#import "WASendSessionMsgViewDelegate-Protocol.h"
#import "WCActionSheetDelegate-Protocol.h"
#import "WCGroupUndoneActionDelegate-Protocol.h"

@class CBaseContact, CMessageWrap, EmoticonBoardView, EmoticonSearchHalfScreenViewController, MMEmoticonView, MMGrowTextView, MMHeadImageView, MMInputMsgReferView, MMQuickSendEmoticonView, MMTransparentButton, MMUIButton, MsgSendOpEntry, NSSet, NSString, NSURL, RecordAdapterView, RelatedEmoticonHalfScreenViewController, SelectAttachmentView, SelectAttachmentViewController, SolitaireTipsView, TranslateToolView, UIButton, UIImageView, UIImpactFeedbackGenerator, UIView, WASendSessionMsgView, WCGroupUndoneActionBar;
@protocol MMInputToolViewCustomizationDelegate, MMInputToolViewDelegate;

@interface MMInputToolView : MMUIView <MMQuickSendEmoticonViewDelegate, WASendSessionMsgViewDelegate, RecordViewDelegate, SolitaireTipsViewDelegate, MMInputMsgReferDelegate, EmoticonInputRecommendMgrExt, WCGroupUndoneActionDelegate, TranslateToolViewDelegate, TranslateLanguageSelectViewDelegate, UITextViewDelegate, ISysCallCheckExt, WCActionSheetDelegate, MMGrowTextViewDelegate, MMTransparentButtonDelegate, SelectAttachmentViewControllerDelegate, EmoticonBoardViewDelegate, BaseEmoticonViewDelegate, IRecordPermissionCheckExt, RelatedEmoticonHalfScreenViewControllerDelegate, EmoticonSearchHalfScreenViewControllerDelegate>
{
...
- (void)setPoisitionMode:(unsigned long long)arg1 animated:(_Bool)arg2 fromShake:(_Bool)arg3;
