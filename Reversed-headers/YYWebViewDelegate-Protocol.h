...
@class NSArray, NSError, NSString, NSURLAuthenticationChallenge, NSURLRequest, WKFrameInfo, WKNavigation, WKNavigationAction, WKNavigationResponse, WKScriptMessage;
