...
@class CAGradientLayer, CContact, EnterpriseConnectorLogic, FixDocumentPresent, ForwardMessageLogicController, GameWebReporter, MMJSApiVerifyMgr, MMPageSheetAdapter, MMScrollActionSheet, MMTimer, MMTipsViewController, MMURLHandler, MMWebBottomToolBar, MMWebCoreConfig, MMWebCustomLog, MMWebLiveTitleView, MMWebMProfileTitleView, MMWebProgressBar, MMWebTopBar, MMWebTransHelpButton, MMWebViewFontFloatView, MMWebViewPerformance, MMWebViewPluginScheduler, MMWebViewPresetUI, MMWebViewSpaAuthContext, MMWebviewPrefetchResult, MiniRecTransitionController, NSDictionary, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, NSURL, NSURLRequest, TipsView, UIButton, UIImageView, UILabel, UILongPressGestureRecognizer, UIView, UIViewController, WCDeepLinkHandler, WCWebNavigationEventsStore, WKNavigation, WKWebView, WebViewA8KeyLogicImpl, WebViewJSLogicImpl, WebViewMenuCustomizeLogic, WebViewOAuthLogic, WebViewSanboxSessionLogic, WebViewTimeProfileData;
@protocol MMWebViewDelegate, MMWebViewPreloadContentHandler, YYWebViewInterface;

@interface MMWebViewController : MMUIViewController <MMWebSearchViewDelegate, MMWebMProfileTitleViewDelegate, MMWebLiveTitleViewDelegate, MinimizationTransitionControllerDelegate, MMWebViewDelegate, MMScrollActionSheetDelegate, EnterpriseConnectorLogicDelegate, H5GameScrollActionSheetDelegate, MMWebMenuHeaderViewDelegate, RecentForwardScrollViewDelegate, WCForceTouchPopProtocol, UIGestureRecognizerDelegate, IUiUtilExt, MMTipsViewControllerDelegate, ISysCallCheckExt, WCActionSheetDelegate, MMWebViewFontFloatViewDelegate, WebViewA8KeyLogicDelegate, WebViewJSLogicDelegate, UIScrollViewDelegate, MMJSApiVerifyMgrDelegate, ForwardMessageLogicDelegate, WCCommitViewResultDelegate, WebViewSanboxSessionLogicDelegate, WXCustomWebViewControllerProtocol, YYWebViewDelegate>
{
    ...
    _Bool _m_webviewCurrentFontUpgradeControl;
...
@property(nonatomic) _Bool m_webviewCurrentFontUpgradeControl; // @synthesize m_webviewCurrentFontUpgradeControl=_m_webviewCurrentFontUpgradeControl;
...
- (id)getFastLoadInitURLAndExtraInfoWithUrl:(id)arg1 extraInfo:(id *)arg2;
...
- (void)addWAOpenWxMaterialButton:(id)arg1;
