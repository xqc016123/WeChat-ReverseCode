...
@interface ContactTagNewDetailViewController : MMUIViewController <UITableViewDataSource, UITableViewDelegate, IContactLabelMgrExt, IContactMgrExt, MultiSelectContactsViewControllerDelegate, ContactTagNameEditViewControllerDelegate, MMTableViewIndexViewDelegate>
{
