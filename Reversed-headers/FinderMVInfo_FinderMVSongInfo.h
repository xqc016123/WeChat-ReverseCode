...
@class FinderMVInfo_FinderMVSongInfo_FinderMVSongOperationInfo, NSString;
...
@property(nonatomic) _Bool copyright; // @dynamic copyright;
...
@property(retain, nonatomic) FinderMVInfo_FinderMVSongInfo_FinderMVSongOperationInfo *operationInfo; // @dynamic operationInfo;
