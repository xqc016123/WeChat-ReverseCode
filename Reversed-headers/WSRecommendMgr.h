...
@class MMTimer, NSArray, NSDictionary, NSMutableArray, NSMutableDictionary, NSRecursiveLock, NSString, UIImage, WSLocalWebViewController, WSRecommendColikeStorage, WSRecommendColikeTempModel, WSRecommendHomePageStat, WSRecommendSetting;

@interface WSRecommendMgr : WSTemplateBaseMgr <WSLocalWebViewControllerDelegate, IFunctionMsgExt, PBMessageObserverDelegate, IMinimizeTaskDelegateInterface>
{
    ...
    NSMutableDictionary *_cacheVideoFlowDic;
    UIImage *_mVideoFlowIcon;
    NSDictionary *_from3rdAppShareParams;
    NSArray *_tabListInfo;
}

+ (_Bool)IsSupportTopStoryPlugin;
- (void).cxx_destruct;
@property(retain, nonatomic) NSArray *tabListInfo; // @synthesize tabListInfo=_tabListInfo;
...
@property(retain, nonatomic) NSMutableDictionary *cacheVideoFlowDic; // @synthesize cacheVideoFlowDic=_cacheVideoFlowDic;
...
@property(readonly, nonatomic) NSString *tabParamsText; // @synthesize tabParamsText=_tabParamsText;
...
- (id)categoryIdStringForTab:(unsigned long long)arg1;
- (long long)categoryIdForTab:(unsigned long long)arg1;
- (void)tryRescueMinimizedWSVideoFlowPageWhenBeDismiss:(id)arg1;
...
- (id)minimizePendingTaskContextWithTaskBizKey:(id)arg1 generateType:(unsigned long long)arg2 wsVideoVC:(id)arg3;
- (id)minimizeVideoFlowDefaultIcon;
- (void)removeVideoFlowPageWithKey:(id)arg1;
- (void)cacheVideoFlowPage:(id)arg1 forKey:(id)arg2;
- (id)getCacheVideoFlowPageWithKey:(id)arg1;
...
- (void)updateFirstPageCache:(id)arg1;
...
- (_Bool)preloadSharedPageWebViewIfNeeded:(unsigned long long)arg1;
...
- (id)generatePushingSharedPage:(unsigned long long)arg1 useParallel:(_Bool *)arg2;
