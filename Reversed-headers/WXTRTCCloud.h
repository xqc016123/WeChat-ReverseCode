...
- (void)unregisterAudioVolumeEvaluationListener:(id)arg1 subStream:(_Bool)arg2;
- (void)registerAudioVolumeEvaluationListener:(id)arg1 subStream:(_Bool)arg2 listener:(id)arg3;
