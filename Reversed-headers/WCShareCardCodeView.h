...
@class MMTimer, MMUIActivityIndicatorView, MMUILabel, NSString, UIButton, UIImageView, UILabel, UIScrollView, UIView, WCCardDataCardInfo, WCCardDataCardTPInfo, WCCardDynamicCodeGenerator;
