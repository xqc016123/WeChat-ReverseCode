...
@interface CSettingExt : NSObject <NSCoding>
{
    ...
    _Bool m_hiddenUpdateRemindFinder;
    _Bool m_hiddenUpdateRemindNearybyLive;
    _Bool m_hiddenUpdateRemindIndependentLive;
    ...
    NSString *searchWeAppPlaceHolderForMainFrameTaskBar;
    NSString *searchWeAppWordIdForMainFrameTaskBar;
    NSString *searchWeAppPlaceHolderForMainFrameMore;
    NSString *searchWeAppWordIdForMainFrameMore;
...
@property(nonatomic) _Bool m_bIsUsingSystemFont; // @synthesize m_bIsUsingSystemFont=_m_bIsUsingSystemFont;
@property(nonatomic) unsigned int m_uiFontSize; // @synthesize m_uiFontSize=_m_uiFontSize;
...
@property(nonatomic) _Bool m_hiddenUpdateRemindIndependentLive; // @synthesize m_hiddenUpdateRemindIndependentLive;
@property(nonatomic) _Bool m_hiddenUpdateRemindNearybyLive; // @synthesize m_hiddenUpdateRemindNearybyLive;
@property(nonatomic) _Bool m_hiddenUpdateRemindFinder; // @synthesize m_hiddenUpdateRemindFinder;
...
@property(retain, nonatomic) NSString *searchWeAppWordIdForMainFrameMore; // @synthesize searchWeAppWordIdForMainFrameMore;
@property(retain, nonatomic) NSString *searchWeAppWordIdForMainFrameTaskBar; // @synthesize searchWeAppWordIdForMainFrameTaskBar;
@property(retain, nonatomic) NSString *searchWeAppWordId; // @synthesize searchWeAppWordId;
@property(retain, nonatomic) NSString *searchWeAppPlaceHolderForMainFrameMore; // @synthesize searchWeAppPlaceHolderForMainFrameMore;
@property(retain, nonatomic) NSString *searchWeAppPlaceHolderForMainFrameTaskBar; // @synthesize searchWeAppPlaceHolderForMainFrameTaskBar;
