...
@interface XNetEffectManager : NSObject <XNetRenderTargetDelegate>
{
    ...
    NSMutableArray *_defomationStickers;
    NSMutableArray *_liquifyStickers;
...
@property(retain, nonatomic) NSMutableArray *liquifyStickers; // @synthesize liquifyStickers=_liquifyStickers;
@property(retain, nonatomic) NSMutableArray *defomationStickers; // @synthesize defomationStickers=_defomationStickers;
...
- (void)applyDefomationSticker:(id)arg1;
- (void)applyLiquifySticker:(id)arg1;
