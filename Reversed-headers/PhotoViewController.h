...
@class MMUILabel, MultiImageScrollView, NSMutableArray, NSMutableDictionary, NSSet, NSString, QRCodeInMultiDisplayView, ScanQRCodeLogicController, WCActionSheetWithScanWXCode, WCImageTranslateLogic;
@protocol PhotoViewControllerDelegate;

@interface PhotoViewController : WCDragToCloseViewController <BaseScanLogicDelegate, WCImageTranslateDelegate, QRCodeInMultiDisplayViewDelegate, MultiImageScrollViewDelegate, IHttpCacheExt, WCActionSheetDelegate>
{
...
- (void)tryDoImageSearchReport:(unsigned int)arg1;
- (id)genSearchEntity;
