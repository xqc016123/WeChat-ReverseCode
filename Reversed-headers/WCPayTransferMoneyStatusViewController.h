...
@class GetTransferWordingResponse, MMTipsViewController, NSString, WCActionSheet, WCPayGetTransferWordingCgi, WCPayNoticeBanner;
@protocol WCPayTransferMoneyStatusViewControllerDelegate;

@interface WCPayTransferMoneyStatusViewController : WCPayBaseViewController <WCPayAddressRemarkViewDelegate, WCPayGetTransferWordingCgiDelegate, WCPayNoticeBannerDelegate, WCActionSheetDelegate, MMTipsViewControllerDelegate, ILinkEventExt>
{
