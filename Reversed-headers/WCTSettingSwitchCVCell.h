...
@class NSString, WCTSettingSwitchView;

@interface WCTSettingSwitchCVCell : UICollectionViewCell <ZZFlexibleLayoutViewProtocol>
{
    WCTSettingSwitchView *_view;
}

+ (double)viewHeightByDataModel:(id)arg1;
- (void).cxx_destruct;
@property(readonly, nonatomic) WCTSettingSwitchView *view; // @synthesize view=_view;
