...
@interface RecordUploadCDNMgr : MMObject <RecordUploadTaskDelegate, IBufferUploadExt, MMAppAttachFileMgrExt, ICdnComMgrExt, PBMessageObserverDelegate>
{
    ...
    unsigned int m_uiCurUploadTaskTotalSize;
...
- (unsigned int)remainUploadSize:(id)arg1;
- (unsigned int)totalUploadSize:(id)arg1;
