...
#import "FullScreenVideoProgressBarDelegate-Protocol.h"
#import "SightIconViewDelegate-Protocol.h"

@class MMUILabel, NSObject, NSString, SightIconView, UIButton, UIImageView, UILabel, UIView, WCPlayerConfig, WCPlayerConfigFullScreenProgressBar, WCPlayerShareableButton;
@protocol WCPlayerConfigDelegate;

@interface WCPlayerFullScreenConfigControlView : WCPlayerControlView <SightIconViewDelegate, FullScreenVideoProgressBarDelegate>
{
    _Bool _fullScreen;
    _Bool _shrink;
