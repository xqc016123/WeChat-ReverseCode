...
@interface WAWebViewPlugin_VideoPlayer : WAWebViewPlugin_embedView <WAVideoPlayerViewDelegate, WAMediaCastingAirPlayDetectorDelegate, IWAWebViewPlugin_VideoPlayer>
{
    _Bool _didAppear;
    Class VideoClass;
