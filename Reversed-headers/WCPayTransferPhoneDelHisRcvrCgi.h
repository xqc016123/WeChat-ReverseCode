...
{
    id <WCPayTransferPhoneDelHisRcvrCgiDelegate> _m_delegate;
}

- (void).cxx_destruct;
@property __weak id <WCPayTransferPhoneDelHisRcvrCgiDelegate> m_delegate; // @synthesize m_delegate=_m_delegate;
