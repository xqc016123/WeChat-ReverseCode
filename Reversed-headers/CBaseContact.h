...
@interface CBaseContact : NSObject <PBCoding, NSCoding>
{
    ...
    _Bool _m_bUseHeadImgUrlForDisplay;
    _Bool _m_bUseRoundHeadImage;
    long long m_i64ReferMsgSvrId;
    NSString *m_nsFriendUserName;
    NSDictionary *_externalInfoJSONCache;
}

+ (_Bool)isWeChatPayCollAssistUsername:(id)arg1;
+ (void)initialize;
...
@property(nonatomic) _Bool m_bUseRoundHeadImage; // @synthesize m_bUseRoundHeadImage=_m_bUseRoundHeadImage;
@property(nonatomic) _Bool m_bUseHeadImgUrlForDisplay; // @synthesize m_bUseHeadImgUrlForDisplay=_m_bUseHeadImgUrlForDisplay;
...
@property(retain, nonatomic) NSString *m_nsFriendUserName; // @synthesize m_nsFriendUserName;
@property(nonatomic) long long m_i64ReferMsgSvrId; // @synthesize m_i64ReferMsgSvrId;
...
- (_Bool)isUseSvrHeadImagePluginContact;
- (_Bool)isPluginPresentedContact;
- (_Bool)isWeChatPayHKContact;
- (_Bool)isMinishopAssistContact;
- (_Bool)isWeChatPayCollAssistContact;
- (_Bool)isWeChatPayContact;
...
- (_Bool)isQQ;
- (_Bool)isQQMBlog;
- (_Bool)isFavWeAppMsgHolder;
- (_Bool)isTemplateMsgHolder;
- (_Bool)isFileHelper;
- (_Bool)isWWKFSessionHolder;
- (_Bool)isBrandSessionHolder;
- (_Bool)isGroupCard;
- (_Bool)isOpenImKefuContact;
...
- (_Bool)isFinderBlack;
- (_Bool)isFinderNointeresting;
- (void)setSnsBlack:(_Bool)arg1;
- (_Bool)isSnsBlack;
- (void)setSocialBlack:(_Bool)arg1;
- (_Bool)isSocialBlack;
...
- (void)tryHeadImgUrl:(id)arg1;
- (void)tryNickName:(id)arg1;
