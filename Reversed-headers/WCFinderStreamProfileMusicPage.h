...
#import "WCFinderStreamMusicViewModelDelegate-Protocol.h"

@class NSMutableSet, NSString, UILabel, WCFinderAnimationLoadingView, WCFinderStreamFooterView;

@interface WCFinderStreamProfileMusicPage : WCFinderStreamProfileViewPage <UICollectionViewDelegate, UICollectionViewDataSource, WCFinderStreamLayoutDelegate, WCFinderStreamMusicViewModelDelegate, WCFinderStreamFooterViewActionDelegate, WCFinderProfileMusicViewDelegate>
{
...
- (void)viewModel:(id)arg1 removeItemAtIdx:(long long)arg2;
- (void)viewModel:(id)arg1 fetchDataWithError:(id)arg2;
