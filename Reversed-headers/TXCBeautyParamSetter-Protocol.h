...
- (void)setFilterUIImage:(UIImage *)arg1;
...
@optional
- (void)setLeftFilter:(UIImage *)arg1 rightFilter:(UIImage *)arg2 leftStrength:(double)arg3 rightStrength:(double)arg4 leftRatio:(double)arg5;
@end
