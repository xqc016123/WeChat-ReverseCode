...
- (void)updateLikeView;
- (void)updateUIWith:(unsigned long long)arg1 likeCount:(unsigned long long)arg2 commentCount:(unsigned long long)arg3 forwardCount:(unsigned long long)arg4 collectionCount:(unsigned long long)arg5 wxStatusRefCount:(unsigned long long)arg6 commentClose:(_Bool)arg7 allowForward:(_Bool)arg8 allowFav:(_Bool)arg9;
