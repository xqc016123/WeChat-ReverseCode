...
@class LaunchImage, NSMutableArray, NSMutableSet, NSString, PreEnterShowGlobalAlertStep, ShowRatingAchive;

@interface PreEnterWechatLogic : MMObject <IMMFacebookMgrExt, PreEnterStepDelegate, IAppViewControllerManagerExt, MMConfigMgrExt, INewSyncExt, MessageObserverDelegate, MMKernelExt, IMsgExt>
{
