...
@interface WCFinderPOIRelatedUICollectionReusableView : WCFinderCollectionReusableView <ILinkEventExt, WCFinderHeadImageViewDelegate>
{
    ...
    UIView *_feedCountSeparateLine;
    MMUILabel *_feedCountLabel;
}

+ (double)headerViewHeightWith:(id)arg1 bindContact:(id)arg2 noticeWording:(id)arg3 isDataEmpty:(_Bool)arg4 width:(double)arg5 onlyShowPoiName:(_Bool)arg6;
- (void).cxx_destruct;
@property(retain, nonatomic) MMUILabel *feedCountLabel; // @synthesize feedCountLabel=_feedCountLabel;
@property(retain, nonatomic) UIView *feedCountSeparateLine; // @synthesize feedCountSeparateLine=_feedCountSeparateLine;
...
@property(retain, nonatomic) MMUILabel *titleTipsLabel; // @synthesize titleTipsLabel=_titleTipsLabel;
...
- (void)updateWith:(id)arg1 bindContact:(id)arg2 noticeWording:(id)arg3 isDataEmpty:(_Bool)arg4 onlyShowPoiName:(_Bool)arg5 totalFeedsCount:(long long)arg6;
