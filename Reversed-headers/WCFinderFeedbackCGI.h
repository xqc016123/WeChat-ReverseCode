...
- (void)createRequest;
- (id)initWithFeedbackType:(unsigned long long)arg1 subType:(long long)arg2 objectID:(unsigned long long)arg3 nonceID:(id)arg4 sessionBuffer:(id)arg5 scene:(unsigned long long)arg6 successBlock:(CDUnknownBlockType)arg7 failBlock:(CDUnknownBlockType)arg8;
