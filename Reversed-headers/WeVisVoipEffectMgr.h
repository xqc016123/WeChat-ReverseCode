...
@class EAGLContext, MMGPUSpatiotemporalDenosing, NSMutableArray, NSRecursiveLock, SpatiotemporalDenosingPreProcess, WCLoopMetricsCollector, WeVisByPassFS, WeVisGLFrameBuffer, WeVisGLRGBA2YUVTwoPassFS, WeVisGLTexture, WeVisGLYUV2RGBA, WeVisPixelBuffer;
...
@interface WeVisVoipEffectMgr : NSObject
{
    ...
    long long deFaceWrinkleId;
    float faceAutoSlimerRate[10];
...
- (void)setLowHighHairLineTemplate;
- (void)setShortLongChin:(float)arg1;
- (void)setShortLongChinTemplate;
...
- (void)dealloc;
- (id)initWithGlContext:(id)arg1 sceneType:(int)arg2;
