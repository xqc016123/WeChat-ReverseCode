...
@class CAGradientLayer, NSString, RichTextView, UIImageView, UILabel, WCFinderAuthInfoIconView, WCFinderFeedContentVM, WCFinderFullNewMultiMediaView, WCFinderFullPlayerProgressBar, WCFinderHeadImageView;
@protocol WCFinderPickerListTableViewCellDelegate;

@interface WCFinderPickerListTableViewCell : WCFinderTableViewCell <WCFinderFullPlayerProgressBarDelegate, WCFinderFeedContentMediaActionProtocol, ILinkEventExt, WCFinderFocusCellProtocol>
{
    _Bool _isPaused;
