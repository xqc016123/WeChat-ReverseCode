...
@interface TXCHWVideoEncoder : TXIVideoEncoder
{
    ...
    CDUnknownBlockType _dropFrameChecker;
    long long _receivedFrameCount;
    long long _droppedFrameCount;
}

- (void).cxx_destruct;
@property _Bool enableEncodeCache; // @synthesize enableEncodeCache=_enableEncodeCache;
@property long long droppedFrameCount; // @synthesize droppedFrameCount=_droppedFrameCount;
@property long long receivedFrameCount; // @synthesize receivedFrameCount=_receivedFrameCount;
@property(copy) CDUnknownBlockType dropFrameChecker; // @synthesize dropFrameChecker=_dropFrameChecker;
...
- (int)releaseEncoder;
- (int)createEncoder:(const struct TXSVideoEncoderParam *)arg1 IsRealTime:(_Bool)arg2;
- (struct __CFString *)h26xProfileLevelFromEncoderProfile:(int)arg1;
- (int)initEncoder:(const struct TXSVideoEncoderParam *)arg1;
