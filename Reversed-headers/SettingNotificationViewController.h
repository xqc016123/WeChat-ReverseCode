...
@class DelaySwitchSettingLogic, MMNotificationSetting, NSString, RingToneSettingCellHandler, UISwitch, WCActionSheet;

@interface SettingNotificationViewController : NewSettingBaseViewController <NewMessageRingBroadcast, WCActionSheetDelegate>
{
