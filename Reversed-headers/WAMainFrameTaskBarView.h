...
#import "WAMainFrameDesktopContainerViewDelegate-Protocol.h"
...
#import "WAMainFrameTaskBarSectionSearchViewDelegate-Protocol.h"
#import "WAMainFrameTaskBarSectionWeAppViewDelegate-Protocol.h"
#import "WCMainWindowExt-Protocol.h"

@class CADisplayLink, CAGradientLayer, DynamicBackgroundSystemConfig, MFTitleView, MMUIViewController, NSMutableArray, NSString, NewMainFrameRightTopMenuBtn, UIButton, UICollectionView, UIImageView, UILabel, UISearchBar, WADynamicBackgroundGLViewController, WAMainFrameDesktopContainerView, WAMainFrameTaskBarCloseArea, WAMainFrameTaskBarDotLoadingView, WAMainFrameTaskBarLogic, WAMainFrameTaskBarSectionMyWeAppView, WAMainFrameTaskBarSectionWeAppView, WATaskBarCollectionViewLayout;
@protocol WAMainFrameTaskBarViewDelegate;

@interface WAMainFrameTaskBarView : UIView <UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, WADynamicBackgroundGLViewControllerDelegate, WAMainFrameTaskBarSectionWeAppViewDelegate, WAMainFrameTaskBarSectionBaseViewReportDelegate, WAMainFrameTaskBarSectionOtherViewDelegate, IUiUtilExt, UIGestureRecognizerDelegate, WAMainFrameDesktopContainerViewDelegate, WCMainWindowExt, MMLimitedModeExt, WAMainFrameTaskBarSectionSearchViewDelegate, MiniTaskUIMgrExt>
{
