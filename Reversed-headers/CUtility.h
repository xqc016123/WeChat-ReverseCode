...
+ (void)resetTimeOfDetectSystemErrorWarningReboot;
+ (void)setTimeOfDetectSystemErrorWarningReboot;
+ (unsigned int)getTimeElapsedSinceLastDetectSystemErrorWarningReboot;
