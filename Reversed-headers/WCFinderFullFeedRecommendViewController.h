...
#import "WCFinderFeedRecommendVMDelegate-Protocol.h"
#import "WCFinderFeedRecommendVMExt-Protocol.h"
...
#import "WCFinderPullDownRefreshHeaderViewStatusDelegate-Protocol.h"
...
#import "WCFinderTimelineJumpViewDelegate-Protocol.h"
...
@class MMScrollViewProxy, MMUILabel, NSIndexPath, NSMutableDictionary, NSString, PAGView, UIImageView, UILabel, UIMonitorTableView, UITapGestureRecognizer, UIView, UIViewController, WCActionSheet, WCFinderFeedRecommendVM, WCFinderMsgBubbleMgrPanelView, WCFinderOpenTimelineParams, WCFinderPullDownRefreshHeaderView, WCFinderRefreshTableFooterView, WCFinderScrollActionSheet, WCFinderTimelineJumpView, WCFinderTipBarView, WCStoryTouchToDismissView;
@protocol WCFinderCommentBaseViewProtocol, WCFinderFullFeedRecommendViewControllerDelegate;

@interface WCFinderFullFeedRecommendViewController : MMUIViewController <UITableViewDelegate, UITableViewDataSource, WCFinderFeedRecommendVMExt, WCFinderContactExt, WCFinderRefreshTableFooterViewDelegate, EGORefreshTableHeaderDelegate, WCCommitViewResultDelegate, WCFinderRedDotNotifyExt, WCFinderFullMultiMediaTableViewCellDelegate, WCActionSheetDelegate, MMScrollActionSheetDelegate, WCGeneralListMonitorExt, WCFinderPostingCommentExt, WCFinderCommentDetailViewControllerDelegate, WCFinderVideoPlayerExt, WCFinderRedDotExt, WCFinderFeedRecommendVMDelegate, WCFinderFeedBaseViewControllerProtocol, WCGeneralMonitorDelegate, WCFinderFriendLiveSectionTableViewCellDelegate, WCFinderMsgBubbleMgrPanelViewDelegate, PAGViewListener, WCFinderCardWebViewControllerDelegate, WCFinderPullDownRefreshHeaderViewStatusDelegate, WCFinderTimelineJumpViewDelegate, RecentForwardScrollViewDelegate, WCFinderFeedFriendsLikeListViewControllerDelegate, ForwardMessageLogicDelegate, WCFinderTimelineNetworkTipProtocol, MMLiveMorphDismissTarget, RingBackInfoDisplaySheetViewDelegate, WCFinderTabViewControllerProtocol>
{
    ...
    UIView *_switchAnimationMaskView;
    PAGView *_switchAnimationView;
    MMUILabel *_switchTipsLabel;
...
@property(nonatomic) _Bool needShowSwitchTips; // @synthesize needShowSwitchTips=_needShowSwitchTips;
@property(retain, nonatomic) MMUILabel *switchTipsLabel; // @synthesize switchTipsLabel=_switchTipsLabel;
@property(retain, nonatomic) PAGView *switchAnimationView; // @synthesize switchAnimationView=_switchAnimationView;
@property(retain, nonatomic) UIView *switchAnimationMaskView; // @synthesize switchAnimationMaskView=_switchAnimationMaskView;
...
- (double)splitViewFloatPercent:(id)arg1;
...
- (void)reportStatsWithoutTidImmediately:(id)arg1;
