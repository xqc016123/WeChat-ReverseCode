...
#import "WSShortVideoFlowTableViewCellDelegate-Protocol.h"
...
@class ForwardMessageLogicController, MMUILabel, NSIndexPath, NSString, UIImageView, UIView, WCTimeLineFooterView, WSFullVideoDragEducateView, WSShortVideoFlowTableViewCell, WSShortVideoFullScreenController, WSVideoModel, WSVideoTagInfo;

@interface WSShortVideoFlowViewController : WSVideoFlowBaseViewController <WSVideoFlowDataDelegate, UITableViewDelegate, UITableViewDataSource, tableViewDelegate, WSShortVideoFlowTableViewCellDelegate, MMRefreshTableFooterDelegate, UIViewControllerAnimatedTransitioning, WSVideoPlayerViewDelegate, WSFullVideoDragEducateViewDelegate, ITopStoryPluginMsgExt, WSVideoWowEducateDelegate>
{
    UIView *_navBarBkg;
    UIView *_headerView;
    ...
    WSShortVideoFlowTableViewCell *_interactiveCell;
    WSShortVideoFlowTableViewCell *_feedBackingCell;
    ...
    int _cgiStatus;
    WSShortVideoFullScreenController *_fullPlayController;
    ...
    _Bool _bForbidChangeInteractiveCell;
    UIImageView *_transitionVideoImageView;
    WSShortVideoFlowTableViewCell *_goodLookInteractiveCell;
    NSIndexPath *_indexPathTapToJump;
    struct CGSize _lastViewSize;
}

- (void).cxx_destruct;
@property(retain, nonatomic) NSIndexPath *indexPathTapToJump; // @synthesize indexPathTapToJump=_indexPathTapToJump;
@property(retain, nonatomic) WSShortVideoFlowTableViewCell *goodLookInteractiveCell; // @synthesize goodLookInteractiveCell=_goodLookInteractiveCell;
@property(nonatomic) _Bool bForbidChangeInteractiveCell; // @synthesize bForbidChangeInteractiveCell=_bForbidChangeInteractiveCell;
...
- (void)onRefreshGoodLookCell:(id)arg1;
...
- (void)fetchNextPage;
- (void)expandRecommendCell:(id)arg1;
