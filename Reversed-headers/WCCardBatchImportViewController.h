...
@class MMToastViewController, NSMutableArray, NSString, UIButton, WCCardAcceptCardListInfo, WCCardChooseEmptyView, WCCardChoosePeopleLabelView, WCCardPkgBackView;
