...
@interface FavoritesMgr : MMUserService <PBMessageObserverDelegate, FavoritesUploadMgrDelegate, FavoritesDownloadMgrDelegate, FavoritesBatchGetMgrDelegate, FavoritesSyncMgrDelegate, FavoritesBatchDelMgrDelegate, FavSecurityDelegate, FavoritesTagMgrDelegate, MMServiceProtocol>
{
