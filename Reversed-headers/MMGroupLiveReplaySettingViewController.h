...
#import "MMGroupLiveReplaySettingPickerControllerDelegate-Protocol.h"

@class LiveInfo, MMLiveTask, MMUILabel, NSString, UIButton, UIView;

@interface MMGroupLiveReplaySettingViewController : MMUIViewController <MMGroupLiveMgrExt, MMGroupLiveReplaySettingPickerControllerDelegate, MMAcceptAgreementResultViewControllerDelegate>
{
...
- (void)setupUI;
- (void)updateReplayButtonIfReplayError;
- (void)updateReplayButtonIfReplayExpired;
