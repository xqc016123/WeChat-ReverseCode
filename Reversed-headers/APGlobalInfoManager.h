...
@class MidasConfig, MidasIAPCache, MidasIAPNetworkMonitor, MidasIAPUserInfo, MidasIapOrderInfo, MidasLifecycleInfo, NSArray, NSDictionary, NSString;
...
@interface APGlobalInfoManager : NSObject
{
    ...
    MidasConfig *_configHandler;
    NSDictionary *_manualReprovideFailedData;
    NSArray *_manualReprovideSuccessfulData;
}

+ (id)singleton;
@property(copy, nonatomic) NSArray *manualReprovideSuccessfulData; // @synthesize manualReprovideSuccessfulData=_manualReprovideSuccessfulData;
@property(copy, nonatomic) NSDictionary *manualReprovideFailedData; // @synthesize manualReprovideFailedData=_manualReprovideFailedData;
@property(retain, nonatomic) MidasConfig *configHandler; // @synthesize configHandler=_configHandler;
