...
@class FullScreenViewController, MMDragManager, NSString, SessionForwardRecordLogic, SharePreConfirmView, SightIconView, UIDragInteraction, UIImage, UIImageView, UILongPressGestureRecognizer, UITapGestureRecognizer, WCDataItem, WCMediaItem, WCMomentsScrollActionSheet, WCPlayerConfigControlView, WCPlayerView;
@protocol SNSVideoABTestExt, WCSNSNodeVideoViewDelegate;

@interface WCSNSNodeVideoView : MMUIControl <WCPlayerConfigViewControllerDelegate, WCActionSheetDelegate, WCPlayerConfigDelegate, SharePreConfirmViewDelegate, RecentForwardScrollViewDelegate, MMScrollActionSheetDelegate, WCFacadeExt, UIActionSheetDelegate, MMDragDelegate>
{
    _Bool _isImageReady;
