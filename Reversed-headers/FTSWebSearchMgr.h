...
@class LocationRetriever, NSMutableArray, NSMutableDictionary, NSString, PardusSearchRequest, PardusSearchResponse, ProtobufCGIWrap, WebSearchBoxCtrlInfo;
...
@property(nonatomic) _Bool forceShowFTSSearchBar; // @synthesize forceShowFTSSearchBar=_forceShowFTSSearchBar;
