...
@interface WXGBackupMgr : MMUserService <IMsgExt, MMKernelExt, ChatMigrationGetConnectInfoDelegate, WXGBackupLogicDelegate, WXGBackupEntryViewControllerDelegate, WXGBackupImportMessageHelperDelegate, WCImageFullScreeViewMgrExt, MMServiceProtocol>
{
