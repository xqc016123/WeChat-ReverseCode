...
#import "WCRedEnvelopesSpringFestivalActivtyEntryViewDelegate-Protocol.h"

@class CEmoticonWrap, EmoticonBoardView, EmoticonCustomAddLogicController, MMBadgeView, MMEmoticonView, MMTextView, NSString, RichTextView, SequenceAnimationObject, UIButton, UILabel, UIView, WCBaseKeyboardToolBar, WCPayNoticeBanner, WCRedEnvelopesMakeRedEnvelopesViewLayout, WCRedEnvelopesSpringFestivalActivtyEntryView, WCUITextField;
@protocol WCRedEnvelopesMakeRedEnvelopesViewControllerDelegate;

@interface WCRedEnvelopesMakeRedEnvelopesViewController : WCRedEnvelopesBaseViewController <WCPayWebImageViewDelegate, WCPayNoticeBannerDelegate, UITableViewDelegate, WCActionSheetDelegate, UITextFieldDelegate, EmoticonBoardViewDelegate, BaseEmoticonViewDelegate, EmoticonCustomAddLogicControllerDelegate, WCRedEnvelopesSpringFestivalActivtyEntryViewDelegate, UITextViewDelegate, ILinkEventExt, MMTableViewInfoDelegate>
{
...
- (void)updateMaskView:(id)arg1 withImageView:(id)arg2;
- (id)cropImage:(id)arg1 forView:(id)arg2;
