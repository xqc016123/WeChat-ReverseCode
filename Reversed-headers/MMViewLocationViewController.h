...
@interface MMViewLocationViewController : MMUIViewController <QMapViewDelegate, WCActionSheetDelegate, ILocationMgrExt, NavigateLogicControllerDelegate, IScanStreetViewMgrExt, IFavoritesExt, INavigateLogicControllerExt, FavTagViewDelegate>
{
    _Bool _canAddToFav;
...
- (id)initWithChatname:(id)arg1 POIInfo:(id)arg2 FromSrc:(unsigned int)arg3;
