...
@class FTSContactMgr, FTSDB, FTSFavMgr, FTSGlobalStat, FTSIndexEngine, FTSMemorySearchMgr, FTSMessageMgr, FTSReportMgr, FTSTopHitMgr, FTSWebSearchMgr, LocalSearchDynamicConfig, MCSBrandContactMgr, NSMutableSet, NSString, WALocalSearchMgr, WANetSearchMgr, WCSearchGroupTrainingMgr, WSMusicMgr, WebSearchRedotMgr;
