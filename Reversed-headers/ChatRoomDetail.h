...
@interface ChatRoomDetail : NSObject <PBCoding, NSCoding>
{
    ...
    _Bool m_bChatRoomDescBannerNotShow;
    unsigned int m_uiChatRoomStatus;
    unsigned int m_uiLocalInfoVersion;
    NSString *m_nsAssociateOpenIMRoomName;
}
...
- (void).cxx_destruct;
@property(nonatomic) _Bool m_bChatRoomDescBannerNotShow; // @synthesize m_bChatRoomDescBannerNotShow;
@property(retain, nonatomic) NSString *m_nsAssociateOpenIMRoomName; // @synthesize m_nsAssociateOpenIMRoomName;
