...
@interface WCFinderLimitModeGuideViewController : MMUIViewController <MMLimitedModeVerifyPasswordUtilLogicDelegate>
{
    ...
    unsigned long long _commenScene;
    UIView *_detailView;
...
+ (void)displayToRootView:(id)arg1 commentScene:(unsigned long long)arg2 type:(long long)arg3 ignoreShareFeedListVC:(_Bool)arg4;
+ (void)displayToRootView:(id)arg1 commentScene:(unsigned long long)arg2 type:(long long)arg3;
+ (_Bool)shouldShowLimitModeGuidForType:(long long)arg1;
+ (long long)displayType:(unsigned long long)arg1;
- (void).cxx_destruct;
...
@property(nonatomic) unsigned long long commenScene; // @synthesize commenScene=_commenScene;
