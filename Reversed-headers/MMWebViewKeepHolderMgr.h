...
@interface MMWebViewKeepHolderMgr : MMUserService <IMinimizeTaskDelegateInterface, PBMessageObserverDelegate, MMResourceMgrExt, IMMFontMgrExt, MMKernelExt, IMusicPlayerExt, MMServiceProtocol>
{
...
- (void)udpateMinimizedHandOffItem:(id)arg1;
