...
- (id)getFileInfoWithStoreTimeType:(long long)arg1 withAll:(id)arg2;
- (id)getFolderInfoWithFileTyeInUse:(int)arg1 withAll:(id)arg2;
- (id)getFolderInfoWithStoreTimeType:(long long)arg1 withAll:(id)arg2;
- (id)getStringWithFileTypeInUse:(int)arg1;
- (id)getStringWithStoreTimeType:(long long)arg1;
