...
@class AMRAudioRecorder, MMNewUploadVoiceMgr, MMNewVoiceInputCacheLogic, NSString, SPXAudioRecorder, SilkAudioRecorder;

@interface AudioSender : MMUserService <AMRAudioRecorderDelegate, SPXAudioRecorderDelegate, SilkAudioRecorderDelegate, MMNewVoiceInputCacheLogicDelegate, UploadVoiceDelegate, MMServiceProtocol>
{
