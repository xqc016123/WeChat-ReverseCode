...
@class ChatRoomInfo, DropdownMenu, GameCenterLoadingFooterView, GameLibraryAppInfo, LoopPageScrollView, MMHorizontalTableView, MMLoadingView, MMTableView, MMTimer, NSMutableArray, NSMutableDictionary, NSString, UIButton, UIPageControl, UIView;
...
- (long long)openDetailView:(id)arg1 sourceScene:(unsigned int)arg2;
