...
@class CALayer, EditFinderImageAttr, EditStoryImageAttr, EditVideoBGMSelectedMusicInfo, NSMutableArray, NSMutableDictionary, NSString, NSURL, UIImage, WCLocationInfo;
