...
@interface WAMediaPreviewViewController : PhotoViewController <WCPlayerConfigDelegate, WCActionSheetDelegate, FullScreenGestureDelegate, WCPlayerDownloaderExt, ForwardMessageLogicDelegate>
{
...
- (_Bool)initMediaViewerWithSources:(id)arg1 current:(int)arg2 appId:(id)arg3 referer:(id)arg4;
- (void)dealloc;
- (id)init;
