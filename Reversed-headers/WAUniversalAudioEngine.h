...
#import "WAUniversalAudioEngineProtocol-Protocol.h"

@class AVAudioEngine, AVAudioMixerNode, NSMutableDictionary, NSString, WAUniversalAudioPlayerCachePool;
@protocol OS_dispatch_queue;

@interface WAUniversalAudioEngine : NSObject <WAUniversalAudioEngineProtocol>
{
    struct shared_ptr<AudioEngineWaitReady> waiter;
