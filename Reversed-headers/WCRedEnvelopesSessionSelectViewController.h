...
@class CreateChatLogic, FTSContactMgr, MMTableView, NSMutableArray, NSObject, NSString, UIAlertController, WCDataSearcher, WCRedEnvelopesMultiSelectContactsViewController;
