...
- (void)reportInitReady:(unsigned int)arg1 path:(id)arg2 isPreload:(unsigned int)arg3 splashADState:(unsigned int)arg4 canShowLoadingAdvert:(_Bool)arg5 useRenderingCache:(_Bool)arg6;
...
- (void)beginWhenWeAppInitWithExtraParams:(id)arg1;
...
- (void)registerOpenWeAppInfo:(id)arg1 appVersion:(long long)arg2 appState:(unsigned long long)arg3 scene:(unsigned long long)arg4 isPluginCode:(unsigned int)arg5 appServiceType:(unsigned long long)arg6 pagePath:(id)arg7;
- (id)init;
