...
@class CAAnimationGroup, CABasicAnimation, CameraScanBlurButtonWrapView, CameraScanCodesCenterDotView, ImageFitWithBlurredBackgroundView, MMUIButton, NSMutableArray, NSString, UIImageView, UILabel, UIView;
@protocol CameraScanCodesContentViewDelegate;

@interface CameraScanCodesContentView : CameraScanBaseContentView <CAAnimationDelegate>
{
