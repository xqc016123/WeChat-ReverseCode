...
@class MMTableView, MMUIActivityIndicatorView, MMUIScrollView, MMUIView, NSMutableDictionary, NSString, WCNewShareCardListLogicController;

@interface WCNewShareCardListViewController : MMUIViewController <WCNewShareCardListLogicDelegate, UITableViewDelegate, UITableViewDataSource, WCCardPackageViewControllerDelegate, WCNewCardDetailViewControllerDelegate, WCActionSheetDelegate, MMTipsViewControllerDelegate>
{
    ...
    MMUIActivityIndicatorView *_footerActivityView;
...
@property(retain, nonatomic) MMUIActivityIndicatorView *footerActivityView; // @synthesize footerActivityView=_footerActivityView;
