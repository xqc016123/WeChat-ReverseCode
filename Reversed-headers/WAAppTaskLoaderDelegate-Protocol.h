...
@class NSArray, NSDictionary, NSString, UIViewController, WACacheVersionPreCheckerContextResult, WAContact, WAPackageConfig, WAUINavigationController, WAWebViewController;
...
- (_Bool)setupConfigDataWithAppID:(NSString *)arg1 contact:(WAContact *)arg2 packageConfig:(WAPackageConfig *)arg3 relativeURL:(NSString *)arg4 isLazyLoad:(_Bool)arg5;
...
- (void)navigationControllerDidChangeTo:(WAUINavigationController *)arg1;
