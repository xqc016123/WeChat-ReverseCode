...
@class FinderContactMsgInfo, NSArray, NSData, NSNumber, NSString, WCFinderCommentMentionArray, WCFinderContact;
...
@interface WCFinderComment : NSObject <WCTColumnCoding, PBCoding, WCTTableCoding>
{
    ...
    long long commentEntranceScene;
    WCFinderContact *authorContact;
    WCFinderContact *replyContact;
    WCFinderCommentMentionArray *mentionArray;
...
@property(retain, nonatomic) WCFinderCommentMentionArray *mentionArray; // @synthesize mentionArray;
@property(retain, nonatomic) WCFinderContact *replyContact; // @synthesize replyContact;
@property(retain, nonatomic) WCFinderContact *authorContact; // @synthesize authorContact;
@property(nonatomic) long long commentEntranceScene; // @synthesize commentEntranceScene;
...
@property(nonatomic) unsigned long long rootCommentID; // @synthesize rootCommentID;
...
- (_Bool)isReplyAuthor;
- (_Bool)isAuthorLiked;
- (_Bool)shouldShowHightlightForClick;
