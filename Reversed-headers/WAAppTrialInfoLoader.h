...
- (void)updateNotifyInfoWithDownloadUrl:(id)arg1 md5Str:(id)arg2 extInfo:(id)arg3 oldNotify:(id)arg4 closeTask:(_Bool)arg5;
...
- (_Bool)isLocalEntrancePackageValid:(id)arg1 checkSum:(id)arg2 debugModeType:(unsigned long long)arg3;
