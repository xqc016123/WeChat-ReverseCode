...
@class NSString, WCTBaseSettingView;

@interface WCTBaseSettingTVCell : MMTableViewCell <ZZFlexibleLayoutViewProtocol>
{
    WCTBaseSettingView *_view;
}

+ (double)viewHeightByDataModel:(id)arg1;
- (void).cxx_destruct;
@property(readonly, nonatomic) WCTBaseSettingView *view; // @synthesize view=_view;
