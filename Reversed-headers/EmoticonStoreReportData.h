...
+ (void)ReportEmoticonBrowsePageExposure:(id)arg1 activityID:(id)arg2 pid:(id)arg3 designerUin:(id)arg4 emotionScene:(long long)arg5 sessionID:(id)arg6 lensID:(id)arg7 linkId:(id)arg8 linkExposured:(_Bool)arg9 linkClicked:(_Bool)arg10;
...
+ (void)ReportShowDescToEmoticon:(id)arg1 expId:(id)arg2 totalCount:(unsigned long long)arg3 sessionId:(id)arg4 wrapList:(id)arg5 chatID:(id)arg6 recSessionId:(id)arg7 remoteWordListMeta:(id)arg8;
