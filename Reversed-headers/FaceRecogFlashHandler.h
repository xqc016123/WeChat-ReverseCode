...
@interface FaceRecogFlashHandler : FaceRecogBaseHandler <YtDeviceDelegate, CameraVideoDeviceDelegate, FaceRecogConfigLogicDelegate>
{
...
@property(readonly, nonatomic) NSString *numbersToRead;
