...
- (void)createRequest;
- (id)initWithFinderTaskId:(id)arg1 productId:(unsigned long long)arg2 shopRequestId:(id)arg3 successBlock:(CDUnknownBlockType)arg4 failBlock:(CDUnknownBlockType)arg5;
