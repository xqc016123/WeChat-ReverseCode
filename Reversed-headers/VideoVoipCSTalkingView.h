...
@class AVAudioPlayer, AVCaptureVideoPreviewLayer, CContact, MMHDHeadImageView, MMTimerLabel, MMUIButton, MultiTalkHDHeadView, NSString, SmallCameraView, UIImageView, UILabel, UIView, VOIPVideoRender, VOIPVideoToVoiceView, VoipDescriptionButton;
