...
@class MMOnlineSilentDownloadLogicController, MMTimer, NSMutableArray, NSMutableSet, NSNumber, NSString, SendActiveCGI;

@interface OnlineClientMgr : MMUserService <IMMLanguageMgrExt, PBMessageObserverDelegate, IMMNewSessionMgrExt, MMKernelExt, INewSyncExt, IMsgExt, MMServiceProtocol>
{
