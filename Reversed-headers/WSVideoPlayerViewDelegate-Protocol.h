...
@class CdnDownloadTaskInfo, NSDictionary, NSString, UIButton, WSShortVideoFlowPlayerControlView, WSVideoDotInfo, WSVideoModel;
...
- (void)enableFullScreen:(_Bool)arg1 orientation:(long long)arg2 video:(WSShortVideoFlowPlayerControlView *)arg3;
