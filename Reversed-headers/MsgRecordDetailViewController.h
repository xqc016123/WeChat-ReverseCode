...
@class CBaseContact, CMessageWrap, FavForwardLogicController, MMTableView, MMUIWindow, NSArray, NSMutableDictionary, NSString, ScanQRCodeLogicController, UIView, WCActionSheetWithScanWXCode, WCPlayerConfigViewController;
...
- (void)selectMVDataWithNodeView:(id)arg1 data:(id)arg2;
