...
@class CADisplayLink, CEmoticonWrap, EmoticonPreviewWindowViewController, EmoticonRecommendBoardCgi, EmoticonRecommendMessageContext, NSArray, NSIndexPath, NSString, RelatedEmoticonReportObject, UICollectionView, UICollectionViewFlowLayout, UILongPressGestureRecognizer, WSSImilarPageModel;
