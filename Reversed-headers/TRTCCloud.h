...
#import "TXCMediaRecorderDelegate-Protocol.h"
...
@class NSDateFormatter, NSHashTable, NSMutableDictionary, NSString, TRTCConfig, TRTCDashBoard, TRTCEncodeTypeDecision, TRTCParams, TRTCRoomInfo, TRTCVideoEncParam, TRTCVideoFrame, TXAudioEffectManager, TXCAudioVolumeEvaluator, TXCCaptureAndEnc, TXCMediaRecorder, TXDeviceManager;
...
@interface TRTCCloud : NSObject <TXINotifyDelegate, TXICaptureAndEncDelegate, TXIRenderAndDecDelegate, TXBeautyManagerTraitControl, TXICustomRenderDelegate, TXICustomPreprocessDelegate, TRTCAudioFrameDelegate, TXIAudioCorePlayDelegate, TXCAudioEventDelegate, TXIAudioMixedAllDataDelegate, TXIAudioFileWriteDelegate, TXCMediaRecorderDelegate>
{
    ...
    _Bool _enableSubCustomVideoCapture;
    _Bool _enableCustomAudioCapture;
    _Bool _enterRoomOptionKeepAVCapture;
    _Bool _requestQuitRoomWhenTerminated;
    ...
    TXCMediaRecorder *_mediaRecorder;
    long long _currentRecordResolution;
...
- (id).cxx_construct;
- (void).cxx_destruct;
@property(nonatomic) long long currentRecordResolution; // @synthesize currentRecordResolution=_currentRecordResolution;
@property(retain, nonatomic) TXCMediaRecorder *mediaRecorder; // @synthesize mediaRecorder=_mediaRecorder;
...
@property(nonatomic) _Bool requestQuitRoomWhenTerminated; // @synthesize requestQuitRoomWhenTerminated=_requestQuitRoomWhenTerminated;
@property(nonatomic) _Bool enterRoomOptionKeepAVCapture; // @synthesize enterRoomOptionKeepAVCapture=_enterRoomOptionKeepAVCapture;
...
@property(nonatomic) _Bool enableSubCustomVideoCapture; // @synthesize enableSubCustomVideoCapture=_enableSubCustomVideoCapture;
...
- (void)enableNetworkBlackStream:(_Bool)arg1;
...
- (void)enableSubCustomVideoCapture:(_Bool)arg1;
...
- (_Bool)setupH265EnabledByServerConfig:(_Bool)arg1;
...
- (void)mediaRecorder:(id)arg1 onLocalRecordComplete:(int)arg2 storagePath:(id)arg3;
- (void)mediaRecorder:(id)arg1 onLocalRecording:(long long)arg2 storagePath:(id)arg3;
- (void)mediaRecorder:(id)arg1 onLocalRecordBegin:(int)arg2 storagePath:(id)arg3;
- (void)stopLocalRecording:(_Bool)arg1;
...
- (void)snapshotRemoteVideo:(id)arg1 isMainStream:(_Bool)arg2 from:(unsigned long long)arg3 completionBlock:(CDUnknownBlockType)arg4;
...
- (void)enableH265EncodeByPrivateAPI:(_Bool)arg1;
- (_Bool)enableH265EncodeByParams:(id)arg1;
- (void)enableBlackStream:(_Bool)arg1;
- (_Bool)enableBlackStreamByParams:(id)arg1;
...
- (_Bool)isNumericRoom:(unsigned int)arg1;
...
- (void)extractBizInfoAndProcess:(id *)arg1 key:(id)arg2 value:(id *)arg3 remove:(_Bool)arg4;
