...
+ (_Bool)isSpecialNoBrandUserNames:(id)arg1;
- (void).cxx_destruct;
...
- (id)selectWithChatName:(id)arg1 where:(const struct Expression *)arg2 orders:(const SyntaxList_64caf671 *)arg3;
- (id)GetMinMessageLocalIdByChatName:(id)arg1 where:(const struct Expression *)arg2 groupBy:(const SyntaxList_7f15fe8c *)arg3;
...
- (_Bool)UpdateMessageByChatName:(id)arg1 OnPropertys:(const SyntaxList_7f15fe8c *)arg2 toValues:(id)arg3 where:(const struct Expression *)arg4;
...
- (unsigned int)replaceMessage:(id)arg1 withChatName:(id)arg2 onProperty:(const SyntaxList_7f15fe8c *)arg3;
