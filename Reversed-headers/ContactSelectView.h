...
@class CContact, ContactsDataLogic, MMTableView, NSDictionary, NSMutableArray, NSMutableDictionary, NSString, WCColorProxy, WCDataSearcher;
@protocol ContactSelectViewDelegate;

@interface ContactSelectView : UIView <tableViewDelegate, MMTableViewIndexViewDelegate, WCSearchDelegate, WCDataSearchDelegate, UITableViewDelegate, UITableViewDataSource, WCActionSheetDelegate, ContactsDataLogicDelegate>
{
    ...
    _Bool _m_bDontHighlightHeaderView;
...
@property(nonatomic) _Bool m_bDontHighlightHeaderView; // @synthesize m_bDontHighlightHeaderView=_m_bDontHighlightHeaderView;
