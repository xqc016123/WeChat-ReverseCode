...
+ (unsigned int)getWebviewFontScaleWithCurrentLevel:(unsigned int)arg1 upgradeControl:(_Bool)arg2;
+ (unsigned int)getWebviewFontScale;
+ (unsigned int)webviewFontLevelWithMaxLevel:(unsigned int)arg1;
+ (unsigned int)webviewFontLevelWithUpgradeControl:(_Bool)arg1;
