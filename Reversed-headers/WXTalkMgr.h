...
@interface WXTalkMgr : MMUserService <AUAudioDataSource, IRemoteControlCheckExt, AVAudioPlayerDelegate, CNetworkStatusExt, IAUAudioDeviceExt, MMServiceProtocol, PBMessageObserverDelegate, IWXTalkPresentExt, IContactMgrExt, MMKernelExt>
{
    _Bool _isInTalkRoom;
