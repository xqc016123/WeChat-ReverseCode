...
@class AudioRecorderUserData, BaseChatCellView, CEmoticonWrap, CMessageWrap, ChatRoomPanelDynamicWeAppItem, ChatRoomToolMessageEventInfo, MMGrowTextView, MMUIViewController, MsgSendOpEntry, NSArray, NSData, NSString, NSURL, ServiceAppData, SolitaireObj, UIImage, UITableView;
