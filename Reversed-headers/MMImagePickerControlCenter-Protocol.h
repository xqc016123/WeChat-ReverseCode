...
@class EditImageAttr, MMAsset, MMImagePickerReportInfo, NSArray, NSDictionary, NSString, SightDraft, WCFinderDataItem, WCFinderEditOptionModel, WCFinderReportPostStateModel;
...
- (void)onAssetPickerControlCenterClickPostFinderLongVideoWithPostStateModel:(WCFinderReportPostStateModel *)arg1;
