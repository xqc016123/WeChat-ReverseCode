...
- (void)performSelectorWrapper:(id)arg1 afterDelay:(double)arg2 inModes:(id)arg3;
- (void)safePerformSelector:(SEL)arg1 onTarget:(id)arg2 withObject:(id)arg3 afterDelay:(double)arg4 delayPrecision:(double)arg5 inModes:(id)arg6;
- (id)init;
