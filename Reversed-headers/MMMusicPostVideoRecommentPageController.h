...
#import "MMMusicPostVideoDataVMDelegate-Protocol.h"

@class MMMusicPostVideoCollectionFooterCell, MMMusicPostVideoDataVM, NSString, UICollectionView;

@interface MMMusicPostVideoRecommentPageController : MMMusicPostVideoBasePageController <MMMusicPostVideoDataVMDelegate, MMMusicPostVideoCollectionCellDelegate>
{
    MMMusicPostVideoDataVM *_dataVM;
...
- (id)initWithMVModel:(id)arg1 canMultiSelect:(_Bool)arg2;
