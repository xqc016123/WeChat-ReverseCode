...
@class BrandTemplateMsgAuthMessageBubbleModel, MMBrandHeadImageView, MMUIButton, MMUILabel, MultiColumnReaderMessageViewModel, NSString, UIButton, UIImageView, UILabel, WAContactGetter, WCSubscriptionNotifyActionHeaderView;
