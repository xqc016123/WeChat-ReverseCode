...
#import "WCFinderHalfScreenEditFrameBlurViewDelegate-Protocol.h"
...
- (void)addBlurView;
- (id)initWithFrame:(struct CGRect)arg1 hiddenCropBtn:(_Bool)arg2 scrollViewParamModel:(id)arg3 forbiddenFrameCrop:(_Bool)arg4;
