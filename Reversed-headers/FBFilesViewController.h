...
@class MMTableView, MMUILabel, NSArray, NSMutableArray, NSString, UIImageView, WCDataSearcher;
@protocol FBFilesViewControllerDelegate;

@interface FBFilesViewController : MMUIViewController <UITableViewDelegate, UITableViewDataSource, WCFileBrowseCellDelegate, WCSearchDelegate, WCDataSearchDelegate, WCFileBrowseServiceExt>
{
