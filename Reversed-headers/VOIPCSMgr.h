...
@interface VOIPCSMgr : MMUserService <IAUAudioDeviceExt, INetworkStatusMgrExt, CNetworkStatusExt, PBMessageObserverDelegate, MMServiceProtocol, AVVideoDeviceSessionDelegate, AVVideoDataSource, AUAudioDataSource, ISysCallCheckExt>
{
    ...
    NSRecursiveLock *_mVideoLocalRenderLock;
    NSRecursiveLock *_mVideoRemoteRenderLock;
...
@property(retain, nonatomic) NSRecursiveLock *mVideoRemoteRenderLock; // @synthesize mVideoRemoteRenderLock=_mVideoRemoteRenderLock;
@property(retain, nonatomic) NSRecursiveLock *mVideoLocalRenderLock; // @synthesize mVideoLocalRenderLock=_mVideoLocalRenderLock;
