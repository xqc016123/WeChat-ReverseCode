...
@class MMUIButton, NSString, UIButton, UILabel, UITapGestureRecognizer, UIView, WCFinderComment, WCFinderCommentLikeView, WCFinderFeedContentTextView, WCFinderHeadImageView;
