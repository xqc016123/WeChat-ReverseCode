...
@interface EmoticonStoreMgr : MMUserService <StoreEmotionExchangeEmotionPackCgiDelegate, MMServiceProtocol, PBMessageObserverDelegate, IAPExt, ICdnComMgrExt, IMMLanguageMgrExt>
{
