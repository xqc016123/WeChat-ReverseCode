...
@class MinimizeAbsorbFloatingView, MinimizeGestureCircleView, MinimizePendingTaskContext, MinimizeRecordFloatingView, MinimizeTaskOuterContentView, NSMutableArray, NSMutableDictionary, NSString, UIButton, UIScrollView, UIView;
...
@interface MinimizeViewController : MMUIViewController <MinimizeDraggableTaskViewDelegate, MinimizeTaskStateViewDelegate, WCActionSheetDelegate, CAAnimationDelegate, MinimizeTaskOuterContentViewDelegate, MinimizeBaseViewDelegate, MinimizeAbsorbFloatingViewDelegate>
{
    ...
    MinimizeRecordFloatingView *_recordFloatingView;
    struct CGPoint _initialAdsorbFloatingViewOrigin;
    struct CGPoint _draggableTaskViewBeginTouchPoint;
}

- (void).cxx_destruct;
@property(retain, nonatomic) MinimizeRecordFloatingView *recordFloatingView; // @synthesize recordFloatingView=_recordFloatingView;
...
- (void)animateHideRecFloatingView;
