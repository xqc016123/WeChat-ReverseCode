...
#import "MMAppMainSceneEventDelegate-Protocol.h"
#import "MMCommonAdapterDelegate-Protocol.h"
#import "ProtobufLiteAdapterDelegate-Protocol.h"
...
@interface MicroMessengerAppDelegate : MMUIResponder <MMCommonAdapterDelegate, ProtobufLiteAdapterDelegate, UIApplicationDelegate, WCLazyInitObjectProtocol, UNUserNotificationCenterDelegate, MMAppMainSceneEventDelegate>
{
...
- (void)internalWitchToUser:(unsigned int)arg1 completion:(CDUnknownBlockType)arg2;
