...
@interface RadarSearchView : MMUIImageView <IShortCutExt, IRadarSearchExt, IMsgExt, UIScrollViewDelegate, RSHeadImageViewDelegate, RSVerifyViewDelegate, CNetworkStatusExt, FriendAsistSessionExt>
{
