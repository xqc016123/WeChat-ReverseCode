...
- (void).cxx_destruct;
@property(nonatomic) unsigned int isSenderStatus; // @synthesize isSenderStatus;
@property(retain, nonatomic) NSString *specifiedChatName; // @synthesize specifiedChatName;
