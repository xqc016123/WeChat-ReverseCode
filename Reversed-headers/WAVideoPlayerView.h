...
#import "WAMediaCastingRoutePickerControllerDataSource-Protocol.h"
#import "WAMediaCastingRoutePickerControllerDelegate-Protocol.h"
...
@interface WAVideoPlayerView : WCPlayerControlView <UIGestureRecognizerDelegate, WMPFVideoAPIProtocol, WAMediaCastingRoutePickerControllerDelegate, WAMediaCastingRoutePickerControllerDataSource, WAStreamPlayerInterface>
{
...
- (void)onSystemVolumeDidChanged:(id)arg1;
