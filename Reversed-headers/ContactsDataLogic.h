...
@class FTSContactMgr, FTSMultiContactSearchLogic, MMTimer, NSDictionary, NSMutableArray, NSMutableDictionary, NSString, WCSTokenPickLogic, WCSmartGroupCore;
...
- (void)filterOnlyWeixinContact:(id)arg1 IgnoreOpenim:(_Bool)arg2;
