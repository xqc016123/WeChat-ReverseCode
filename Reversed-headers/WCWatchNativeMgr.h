...
@interface WCWatchNativeMgr : MMUserService <WCSessionDelegate, PBMessageObserverDelegate, MMKernelExt, INetworkStatusMgrExt, ICdnComMgrExt, IContactMgrExt, IDownloadImageExt, IVideoExt, IMMNewSessionMgrExt, IExptServiceExt, MMServiceProtocol, IMsgExt, IMMQRCodeExt>
{
...
@property(nonatomic) _Bool isCodePayOpen; // @synthesize isCodePayOpen=_isCodePayOpen;
...
- (id)contactDicWithGroupMemberInfosFromContact:(id)arg1 includeStranger:(_Bool)arg2;
