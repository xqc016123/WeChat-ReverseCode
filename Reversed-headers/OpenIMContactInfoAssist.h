...
@class CContact, ContactRelatedGroupLogic, MMTableViewInfo, MMURLHandler, NSString, SendVerifyMsgLogicController, WCFinderContactFinderAssist;
@protocol ContactInfoAssistDelegate;

@interface OpenIMContactInfoAssist : CBaseContactInfoAssist <MMCPLabelDelegate, IAutoSetRemarkExt, SendVerifyMsgViewControllerDelegate, ILinkEventExt, IHDHeadImageViewExt, IOpenImResourceMgrExt, IOpenImContactMgrExt, SetPermissionsViewControllerDelegate, WCFinderContactFinderAssistDelegate>
{
