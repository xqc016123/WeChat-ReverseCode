...
@class CContact, CMessageWrap, ForwardMessageLogicController, MMTipsViewController, MMUINavigationController, NSArray, NSMutableDictionary, NSString, OpenApiParameter, WAContactGetter, WXMediaInternalMessage;
