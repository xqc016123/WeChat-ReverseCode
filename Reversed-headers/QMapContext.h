...
- (id)addPolygon:(id)arg1 withStrokeStyle:(id)arg2;
- (id)addPolyline:(id)arg1;
- (void)createPolyline:(struct _MapRouteInfo *)arg1 polylineView:(id)arg2 scale:(int)arg3;
- (void)createTexturePolyline:(struct _MapRouteInfo *)arg1 polylineView:(id)arg2 scale:(int)arg3;
