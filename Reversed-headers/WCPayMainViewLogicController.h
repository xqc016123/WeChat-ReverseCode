...
@interface WCPayMainViewLogicController : NSObject <IWCPayControlLogicExt, WCPayOpenECardControlLogicExt, WCPayWalletGetAllFunctionCgiDelegate, LocationRetrieveDelegate, WCPayGetGDPRInfoCgiDelegate>
{
