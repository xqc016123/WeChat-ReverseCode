...
+ (id)getSourceViewWithTitle:(id)arg1 fixedColor:(id)arg2 titleColor:(id)arg3 iconImage:(id)arg4 iconImageUrlString:(id)arg5 maxWidth:(double)arg6 tailIconUrl:(id)arg7 withTailTag:(id)arg8 taiDesc:(id)arg9 bubbleType:(unsigned long long)arg10;
