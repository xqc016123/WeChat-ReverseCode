...
@interface WCSessionFlowMgr : MMUserService <MMServiceProtocol, WCSessionFlowListener>
{
    ...
    NSMutableDictionary *specialSessionDatas;
    NSMutableDictionary *specialPageDatas;
    NSString *finderTabSessionID;
    NSString *finderContextID;
}
