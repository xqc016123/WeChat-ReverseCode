...
#import "EditImageTextToolV2Delegate-Protocol.h"
#import "EditImageWidgetToolDelegate-Protocol.h"
#import "MosaicToolDelegate-Protocol.h"

@class CALayer, EditImageCropOverlayView, EditImageDeleteBarView, EditImageWidgetTool, MMTimer, NSArray, NSMutableArray, NSString, UIColor, UIImage, UIPanGestureRecognizer, UITapGestureRecognizer, UIView, WCEditImageScrollView;
...
- (void)confirmEditText:(id)arg1 text:(id)arg2 withColor:(id)arg3 style:(unsigned long long)arg4;
