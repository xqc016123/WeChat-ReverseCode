...
#import "IWCUIKitInputControllerDelegate-Protocol.h"
#import "MMTipsViewControllerDelegate-Protocol.h"

@class MMObject, MMUILabel, MMUIView, NSMutableArray, NSString, UIButton, UIImageView, UILabel, UITapGestureRecognizer, UIView, UIViewController;
...
@interface MMTipsViewController : MMWindowViewController <MMTipsViewControllerDelegate, IWCUIKitInputControllerDelegate>
{
