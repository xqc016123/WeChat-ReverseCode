...
@class MMUILabel, NSDictionary, NSString, TimeoutNumber, UIButton, UIImageView, WCPayControlData, WCPayNoticeBanner;
...
@property(retain, nonatomic) WCPayNoticeBanner *bannerView; // @synthesize bannerView=_bannerView;
