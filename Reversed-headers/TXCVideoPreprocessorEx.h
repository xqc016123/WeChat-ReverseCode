...
+ (id)getVersion;
- (void).cxx_destruct;
@property(nonatomic) _Bool isIOSurfacePixelBufferPool; // @synthesize isIOSurfacePixelBufferPool=_isIOSurfacePixelBufferPool;
...
@property(nonatomic) _Bool isSharpnessEnhancementChanged; // @synthesize isSharpnessEnhancementChanged=_isSharpnessEnhancementChanged;
...
@property(nonatomic) _Bool outputsIOSurfacePixelBuffer; // @synthesize outputsIOSurfacePixelBuffer=_outputsIOSurfacePixelBuffer;
...
- (_Bool)canSkipProcessFrame:(id)arg1;
- (void)outputByte;
